'use strict';var _get=function get(object,property,receiver){if(object===null)object=Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc===undefined){var parent=Object.getPrototypeOf(object);if(parent===null){return undefined;}else{return get(parent,property,receiver);}}else if("value"in desc){return desc.value;}else{var getter=desc.get;if(getter===undefined){return undefined;}return getter.call(receiver);}};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}(function(global,factory){(typeof exports==='undefined'?'undefined':_typeof(exports))==='object'&&typeof module!=='undefined'?factory(exports):typeof define==='function'&&define.amd?define(['exports'],factory):(global=global||self,factory(global.box2d={}));})(undefined,function(exports){'use strict';/*
  ...
  */function b2Assert(condition){if(!condition){for(var _len=arguments.length,args=Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){args[_key-1]=arguments[_key];}// debugger;
throw new(Function.prototype.bind.apply(Error,[null].concat(args)))();}}function b2Maybe(value,def){return value!==undefined?value:def;}var b2_maxFloat=1E+37;// FLT_MAX instead of Number.MAX_VALUE;
...
var b2Version=function(){function b2Version(){var major=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;var minor=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var revision=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;_classCallCheck(this,b2Version);this.major=0;///< significant changes
...
var b2_version=new b2Version(2,3,2);var b2_branch="master";var b2_commit="fbf51801d80fc389d43dc46524520e89043b6faf";function b2ParseInt(v){return parseInt(v,10);}function b2ParseUInt(v){return Math.abs(parseInt(v,10));}function b2MakeArray(length,init){var a=[];for(var i=0;i<length;++i){a.push(init(i));}return a;}function b2MakeNullArray(length){var a=[];for(var i=0;i<length;++i){a.push(null);}return a;}function b2MakeNumberArray(length){var init=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var a=[];for(var i=0;i<length;++i){a.push(init);}return a;}/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2_pi_over_180=b2_pi/180;var b2_180_over_pi=180/b2_pi;var b2_two_pi=2*b2_pi;var b2Abs=Math.abs;var b2Min=Math.min;var b2Max=Math.max;function b2Clamp(a,lo,hi){return a<lo?lo:a>hi?hi:a;}function b2Swap(a,b){// DEBUG: b2Assert(false);
...
var b2Timer=function(){function b2Timer(){_classCallCheck(this,b2Timer);this.m_start=Date.now();}/// Reset the timer.
...
return this;}}]);return b2SimplexVertex;}();var b2Simplex=function(){function b2Simplex(){_classCallCheck(this,b2Simplex);this.m_v1=new b2SimplexVertex();this.m_v2=new b2SimplexVertex();this.m_v3=new b2SimplexVertex();this.m_vertices=[/*3*/];this.m_count=0;this.m_vertices[0]=this.m_v1;this.m_vertices[1]=this.m_v2;this.m_vertices[2]=this.m_v3;}_createClass(b2Simplex,[{key:'ReadCache',value:function ReadCache(cache,proxyA,transformA,proxyB,transformB){// DEBUG: b2Assert(0 <= cache.count && cache.count <= 3);
...
saveCount=simplex.m_count;for(var i=0;i<saveCount;++i){saveA[i]=vertices[i].indexA;saveB[i]=vertices[i].indexB;}switch(simplex.m_count){case 1:break;case 2:simplex.Solve2();break;case 3:simplex.Solve3();break;default:// DEBUG: b2Assert(false);
break;}// If we have 3 points, then the origin is in the corresponding triangle.
...
vertex.w.Copy(vertex.wB).SelfSub(vertex.wA);vertex.a=1.0;simplex.m_count+=1;switch(simplex.m_count){case 1:break;case 2:simplex.Solve2();break;case 3:simplex.Solve3();break;default:// DEBUG: b2Assert(false);
...
var b2ManifoldPoint=function(){function b2ManifoldPoint(){_classCallCheck(this,b2ManifoldPoint);this.localPoint=new b2Vec2();///< usage depends on manifold type
...
},{key:'IsValid',value:function IsValid(){var d_x=this.upperBound.x-this.lowerBound.x;var d_y=this.upperBound.y-this.lowerBound.y;var valid=d_x>=0&&d_y>=0;valid=valid&&this.lowerBound.IsValid()&&this.upperBound.IsValid();return valid;}/// Get the center of the AABB.
...
value:function Contains(aabb){var result=true;result=result&&this.lowerBound.x<=aabb.lowerBound.x;result=result&&this.lowerBound.y<=aabb.lowerBound.y;result=result&&aabb.upperBound.x<=this.upperBound.x;result=result&&aabb.upperBound.y<=this.upperBound.y;return result;}// From Real-time Collision Detection, p179.
...
output.fraction=tmin;return true;}},{key:'TestContain',value:function TestContain(point){if(point.x<this.lowerBound.x||this.upperBound.x<point.x){return false;}if(point.y<this.lowerBound.y||this.upperBound.y<point.y){return false;}return true;}},{key:'TestOverlap',value:function TestOverlap(other){var d1_x=other.lowerBound.x-this.upperBound.x;var d1_y=other.lowerBound.y-this.upperBound.y;var d2_x=this.lowerBound.x-other.upperBound.x;var d2_y=this.lowerBound.y-other.upperBound.y;if(d1_x>0||d1_y>0){return false;}if(d2_x>0||d2_y>0){return false;}return true;}}],[{key:'Combine',value:function Combine(aabb1,aabb2,out){out.Combine2(aabb1,aabb2);return out;}}]);return b2AABB;}();function b2TestOverlapAABB(a,b){var d1_x=b.lowerBound.x-a.upperBound.x;var d1_y=b.lowerBound.y-a.upperBound.y;var d2_x=a.lowerBound.x-b.upperBound.x;var d2_y=a.lowerBound.y-b.upperBound.y;if(d1_x>0||d1_y>0){return false;}if(d2_x>0||d2_y>0){return false;}return true;}/// Clipping for contact manifolds.
...
var b2TreeNode=function(){function b2TreeNode(){var id=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;_classCallCheck(this,b2TreeNode);this.m_id=0;this.aabb=new b2AABB();this.parent=null;// or next
this.child1=null;this.child2=null;this.height=0;// leaf = 0, free node = -1
this.m_id=id;}_createClass(b2TreeNode,[{key:'IsLeaf',value:function IsLeaf(){return this.child1===null;}}]);return b2TreeNode;}();var b2DynamicTree=function(){function b2DynamicTree(){_classCallCheck(this,b2DynamicTree);this.m_root=null;// b2TreeNode* public m_nodes;
// int32 public m_nodeCount;
// int32 public m_nodeCapacity;
this.m_freeList=null;this.m_path=0;this.m_insertionCount=0;this.m_stack=new b2GrowableStack(256);}// public GetUserData(proxy: b2TreeNode<T>): any {
...
//   return proxy.aabb;
// }
_createClass(b2DynamicTree,[{key:'Query',value:function Query(aabb,callback){if(this.m_root===null){return;}var stack=this.m_stack.Reset();stack.Push(this.m_root);while(stack.GetCount()>0){var node=stack.Pop();// if (node === null) {
//   continue;
// }
if(node.aabb.TestOverlap(aabb)){if(node.IsLeaf()){var proceed=callback(node);if(!proceed){return;}}else{stack.Push(verify(node.child1));stack.Push(verify(node.child2));}}}}},{key:'QueryPoint',value:function QueryPoint(point,callback){if(this.m_root===null){return;}var stack=this.m_stack.Reset();stack.Push(this.m_root);while(stack.GetCount()>0){var node=stack.Pop();// if (node === null) {
//   continue;
// }
if(node.aabb.TestContain(point)){if(node.IsLeaf()){var proceed=callback(node);if(!proceed){return;}}else{stack.Push(verify(node.child1));stack.Push(verify(node.child2));}}}}},{key:'RayCast',value:function RayCast(input,callback){if(this.m_root===null){return;}var p1=input.p1;var p2=input.p2;var r=b2Vec2.SubVV(p2,p1,b2DynamicTree.s_r);// DEBUG: b2Assert(r.LengthSquared() > 0);
...
var segmentAABB=b2DynamicTree.s_segmentAABB;var t_x=p1.x+maxFraction*(p2.x-p1.x);var t_y=p1.y+maxFraction*(p2.y-p1.y);segmentAABB.lowerBound.x=b2Min(p1.x,t_x);segmentAABB.lowerBound.y=b2Min(p1.y,t_y);segmentAABB.upperBound.x=b2Max(p1.x,t_x);segmentAABB.upperBound.y=b2Max(p1.y,t_y);var stack=this.m_stack.Reset();stack.Push(this.m_root);while(stack.GetCount()>0){var node=stack.Pop();// if (node === null) {
//   continue;
// }
if(!b2TestOverlapAABB(node.aabb,segmentAABB)){continue;}// Separating axis for segment (Gino, p80).
// |dot(v, p1 - c)| > dot(|v|, h)
...
maxFraction=value;t_x=p1.x+maxFraction*(p2.x-p1.x);t_y=p1.y+maxFraction*(p2.y-p1.y);segmentAABB.lowerBound.x=b2Min(p1.x,t_x);segmentAABB.lowerBound.y=b2Min(p1.y,t_y);segmentAABB.upperBound.x=b2Max(p1.x,t_x);segmentAABB.upperBound.y=b2Max(p1.y,t_y);}}else{stack.Push(verify(node.child1));stack.Push(verify(node.child2));}}}},{key:'AllocateNode',value:function AllocateNode(){// Expand the node pool as needed.
if(this.m_freeList){var node=this.m_freeList;this.m_freeList=node.parent;// this.m_freeList = node.next;
node.parent=null;node.child1=null;node.child2=null;node.height=0;delete node.userData;// = null;
return node;}return new b2TreeNode(b2DynamicTree.s_node_id++);}},{key:'FreeNode',value:function FreeNode(node){node.parent=this.m_freeList;// node.next = this.m_freeList;
node.child1=null;node.child2=null;node.height=-1;delete node.userData;// = null;
this.m_freeList=node;}},{key:'CreateProxy',value:function CreateProxy(aabb,userData){var node=this.AllocateNode();// Fatten the aabb.
var r_x=b2_aabbExtension;var r_y=b2_aabbExtension;node.aabb.lowerBound.x=aabb.lowerBound.x-r_x;node.aabb.lowerBound.y=aabb.lowerBound.y-r_y;node.aabb.upperBound.x=aabb.upperBound.x+r_x;node.aabb.upperBound.y=aabb.upperBound.y+r_y;node.userData=userData;node.height=0;this.InsertLeaf(node);return node;}},{key:'DestroyProxy',value:function DestroyProxy(proxy){// DEBUG: b2Assert(proxy.IsLeaf());
this.RemoveLeaf(proxy);this.FreeNode(proxy);}},{key:'MoveProxy',value:function MoveProxy(proxy,aabb,displacement){// DEBUG: b2Assert(proxy.IsLeaf());
if(proxy.aabb.Contains(aabb)){return false;}this.RemoveLeaf(proxy);// Extend AABB.
// Predict AABB displacement.
var r_x=b2_aabbExtension+b2_aabbMultiplier*(displacement.x>0?displacement.x:-displacement.x);var r_y=b2_aabbExtension+b2_aabbMultiplier*(displacement.y>0?displacement.y:-displacement.y);proxy.aabb.lowerBound.x=aabb.lowerBound.x-r_x;proxy.aabb.lowerBound.y=aabb.lowerBound.y-r_y;proxy.aabb.upperBound.x=aabb.upperBound.x+r_x;proxy.aabb.upperBound.y=aabb.upperBound.y+r_y;this.InsertLeaf(proxy);return true;}},{key:'InsertLeaf',value:function InsertLeaf(leaf){++this.m_insertionCount;if(this.m_root===null){this.m_root=leaf;this.m_root.parent=null;return;}// Find the best sibling for this node
var leafAABB=leaf.aabb;///const center: b2Vec2 = leafAABB.GetCenter();
var index=this.m_root;while(!index.IsLeaf()){var child1=verify(index.child1);var child2=verify(index.child2);var area=index.aabb.GetPerimeter();var combinedAABB=b2DynamicTree.s_combinedAABB;combinedAABB.Combine2(index.aabb,leafAABB);var combinedArea=combinedAABB.GetPerimeter();// Cost of creating a new parent for this node and the new leaf
...
if(cost1<cost2){index=child1;}else{index=child2;}}var sibling=index;// Create a parent for the siblings.
var oldParent=sibling.parent;var newParent=this.AllocateNode();newParent.parent=oldParent;delete newParent.userData;// = null;
newParent.aabb.Combine2(leafAABB,sibling.aabb);newParent.height=sibling.height+1;if(oldParent){// The sibling was not the root.
...
var index2=leaf.parent;while(index2!==null){index2=this.Balance(index2);var _child=verify(index2.child1);var _child2=verify(index2.child2);index2.height=1+b2Max(_child.height,_child2.height);index2.aabb.Combine2(_child.aabb,_child2.aabb);index2=index2.parent;}// this.Validate();
}},{key:'RemoveLeaf',value:function RemoveLeaf(leaf){if(leaf===this.m_root){this.m_root=null;return;}var parent=verify(leaf.parent);var grandParent=parent&&parent.parent;var sibling=void 0;if(parent.child1===leaf){sibling=verify(parent.child2);}else{sibling=verify(parent.child1);}if(grandParent){// Destroy parent and connect sibling to grandParent.
...
var index=grandParent;while(index){index=this.Balance(index);var child1=verify(index.child1);var child2=verify(index.child2);index.aabb.Combine2(child1.aabb,child2.aabb);index.height=1+b2Max(child1.height,child2.height);index=index.parent;}}else{this.m_root=sibling;sibling.parent=null;this.FreeNode(parent);}// this.Validate();
...
if(D.height>E.height){B.child2=D;A.child1=E;E.parent=A;A.aabb.Combine2(C.aabb,E.aabb);B.aabb.Combine2(A.aabb,D.aabb);A.height=1+b2Max(C.height,E.height);B.height=1+b2Max(A.height,D.height);}else{B.child2=E;A.child1=D;D.parent=A;A.aabb.Combine2(C.aabb,D.aabb);B.aabb.Combine2(A.aabb,E.aabb);A.height=1+b2Max(C.height,D.height);B.height=1+b2Max(A.height,E.height);}return B;}return A;}},{key:'GetHeight',value:function GetHeight(){if(this.m_root===null){return 0;}return this.m_root.height;}},{key:'GetAreaRatio',value:function GetAreaRatio(){if(this.m_root===null){return 0;}var root=this.m_root;var rootArea=root.aabb.GetPerimeter();var totalArea=b2DynamicTree.GetAreaNode(this.m_root);/*
          ...
          */return totalArea/rootArea;}},{key:'ComputeHeightNode',value:function ComputeHeightNode(node){if(!node||node.IsLeaf()){return 0;}var height1=this.ComputeHeightNode(node.child1);var height2=this.ComputeHeightNode(node.child2);return 1+b2Max(height1,height2);}},{key:'ComputeHeight',value:function ComputeHeight(){var height=this.ComputeHeightNode(this.m_root);return height;}},{key:'ValidateStructure',value:function ValidateStructure(index){if(index===null){return;}if(index===this.m_root);var node=index;if(node.IsLeaf()){// DEBUG: b2Assert(node.child1 === null);
...
this.ValidateStructure(child1);this.ValidateStructure(child2);}},{key:'ValidateMetrics',value:function ValidateMetrics(index){if(index===null){return;}var node=index;if(node.IsLeaf()){// DEBUG: b2Assert(node.child1 === null);
// DEBUG: b2Assert(node.child2 === null);
// DEBUG: b2Assert(node.height === 0);
...
var child1=node.child1;var child2=node.child2;b2DynamicTree.ShiftOriginNode(child1,newOrigin);b2DynamicTree.ShiftOriginNode(child2,newOrigin);node.aabb.lowerBound.SelfSub(newOrigin);node.aabb.upperBound.SelfSub(newOrigin);}}]);return b2DynamicTree;}();b2DynamicTree.s_r=new b2Vec2();b2DynamicTree.s_v=new b2Vec2();b2DynamicTree.s_abs_v=new b2Vec2();b2DynamicTree.s_segmentAABB=new b2AABB();b2DynamicTree.s_subInput=new b2RayCastInput();b2DynamicTree.s_combinedAABB=new b2AABB();b2DynamicTree.s_aabb=new b2AABB();b2DynamicTree.s_node_id=0;/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2Pair=function b2Pair(proxyA,proxyB){_classCallCheck(this,b2Pair);this.proxyA=proxyA;this.proxyB=proxyB;};/// The broad-phase is used for computing pairs and performing volume queries and ray casts.
/// This broad-phase does not persist pairs. Instead, this reports potentially new pairs.
/// It is up to the client to consume the new pairs and to track subsequent overlap.
var b2BroadPhase=function(){function b2BroadPhase(){_classCallCheck(this,b2BroadPhase);this.m_tree=new b2DynamicTree();this.m_proxyCount=0;// public m_moveCapacity: number = 16;
...
var proxyA=void 0;var proxyB=void 0;if(proxy.m_id<queryProxy.m_id){proxyA=proxy;proxyB=queryProxy;}else{proxyA=queryProxy;proxyB=proxy;}// Grow the pair buffer as needed.
...
this.m_pairBuffer.length=this.m_pairCount;this.m_pairBuffer.sort(b2PairLessThan);// Send the pairs back to the client.
...
function b2PairLessThan(pair1,pair2){if(pair1.proxyA.m_id===pair2.proxyA.m_id){return pair1.proxyB.m_id-pair2.proxyB.m_id;}return pair1.proxyA.m_id-pair2.proxyA.m_id;}/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
...
var clipPoints1=b2CollidePolygons_s_clipPoints1;var clipPoints2=b2CollidePolygons_s_clipPoints2;var np=void 0;// Clip to box side 1
...
var cf=cp.id.cf;cp.id.cf.indexA=cf.indexB;cp.id.cf.indexB=cf.indexA;cp.id.cf.typeA=cf.typeB;cp.id.cf.typeB=cf.typeA;}++pointCount;}}manifold.pointCount=pointCount;}// DEBUG: import { b2Assert } from "../Common/b2Settings";
...
if(edgeAxis.type===0/* e_unknown */){return;}if(edgeAxis.separation>this.m_radius){return;}var polygonAxis=this.ComputePolygonSeparation(b2EPCollider.s_polygonAxis);if(polygonAxis.type!==0/* e_unknown */&&polygonAxis.separation>this.m_radius){return;}// Use hysteresis for jitter reduction.
var k_relativeTol=0.98;var k_absoluteTol=0.001;var primaryAxis=void 0;if(polygonAxis.type===0/* e_unknown */){primaryAxis=edgeAxis;}else if(polygonAxis.separation>k_relativeTol*edgeAxis.separation+k_absoluteTol){primaryAxis=polygonAxis;}else{primaryAxis=edgeAxis;}var ie=b2EPCollider.s_ie;var rf=b2EPCollider.s_rf;if(primaryAxis.type===1/* e_edgeA */){manifold.type=exports.b2ManifoldType.e_faceA;// Search for the polygon normal that is most anti-parallel to the edge normal.
...
if(primaryAxis.type===1/* e_edgeA */){manifold.localNormal.Copy(rf.normal);manifold.localPoint.Copy(rf.v1);}else{manifold.localNormal.Copy(polygonB.m_normals[rf.i1]);manifold.localPoint.Copy(polygonB.m_vertices[rf.i1]);}var pointCount=0;for(var _i5=0;_i5<b2_maxManifoldPoints;++_i5){var separation=void 0;separation=b2Vec2.DotVV(rf.normal,b2Vec2.SubVV(clipPoints2[_i5].v,rf.v1,b2Vec2.s_t0));if(separation<=this.m_radius){var cp=manifold.points[pointCount];if(primaryAxis.type===1/* e_edgeA */){b2Transform.MulTXV(this.m_xf,clipPoints2[_i5].v,cp.localPoint);cp.id=clipPoints2[_i5].id;}else{cp.localPoint.Copy(clipPoints2[_i5].v);cp.id.cf.typeA=clipPoints2[_i5].id.cf.typeB;cp.id.cf.typeB=clipPoints2[_i5].id.cf.typeA;cp.id.cf.indexA=clipPoints2[_i5].id.cf.indexB;cp.id.cf.indexB=clipPoints2[_i5].id.cf.indexA;}++pointCount;}}manifold.pointCount=pointCount;}},{key:'ComputeEdgeSeparation',value:function ComputeEdgeSeparation(out){var axis=out;axis.type=1/* e_edgeA */;axis.index=this.m_front?0:1;axis.separation=b2_maxFloat;for(var i=0;i<this.m_polygonB.count;++i){var s=b2Vec2.DotVV(this.m_normal,b2Vec2.SubVV(this.m_polygonB.vertices[i],this.m_v1,b2Vec2.s_t0));if(s<axis.separation){axis.separation=s;}}return axis;}},{key:'ComputePolygonSeparation',value:function ComputePolygonSeparation(out){var axis=out;axis.type=0/* e_unknown */;axis.index=-1;axis.separation=-b2_maxFloat;var perp=b2EPCollider.s_perp.Set(-this.m_normal.y,this.m_normal.x);for(var i=0;i<this.m_polygonB.count;++i){var n=b2Vec2.NegV(this.m_polygonB.normals[i],b2EPCollider.s_n);var s1=b2Vec2.DotVV(n,b2Vec2.SubVV(this.m_polygonB.vertices[i],this.m_v1,b2Vec2.s_t0));var s2=b2Vec2.DotVV(n,b2Vec2.SubVV(this.m_polygonB.vertices[i],this.m_v2,b2Vec2.s_t0));var s=b2Min(s1,s2);if(s>this.m_radius){// No collision
axis.type=2/* e_edgeB */;axis.index=i;axis.separation=s;return axis;}// Adjacency
if(b2Vec2.DotVV(n,perp)>=0){if(b2Vec2.DotVV(b2Vec2.SubVV(n,this.m_upperLimit,b2Vec2.s_t0),this.m_normal)<-b2_angularSlop){continue;}}else{if(b2Vec2.DotVV(b2Vec2.SubVV(n,this.m_lowerLimit,b2Vec2.s_t0),this.m_normal)<-b2_angularSlop){continue;}}if(s>axis.separation){axis.type=2/* e_edgeB */;axis.index=i;axis.separation=s;}}return axis;}}]);return b2EPCollider;}();b2EPCollider.s_edge1=new b2Vec2();b2EPCollider.s_edge0=new b2Vec2();b2EPCollider.s_edge2=new b2Vec2();b2EPCollider.s_ie=b2ClipVertex.MakeArray(2);b2EPCollider.s_rf=new b2ReferenceFace();b2EPCollider.s_clipPoints1=b2ClipVertex.MakeArray(2);b2EPCollider.s_clipPoints2=b2ClipVertex.MakeArray(2);b2EPCollider.s_edgeAxis=new b2EPAxis();b2EPCollider.s_polygonAxis=new b2EPAxis();b2EPCollider.s_n=new b2Vec2();b2EPCollider.s_perp=new b2Vec2();var b2CollideEdgeAndPolygon_s_collider=new b2EPCollider();function b2CollideEdgeAndPolygon(manifold,edgeA,xfA,polygonB,xfB){var collider=b2CollideEdgeAndPolygon_s_collider;collider.Collide(manifold,edgeA,xfA,polygonB,xfB);}/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
...
var b2Shape=function(){function b2Shape(type,radius){_classCallCheck(this,b2Shape);this.m_type=exports.b2ShapeType.e_unknown;/// Radius of a shape. For polygonal shapes this must be b2_polygonRadius. There is no support for
...
/// @return the shape type.
  ...
  * 3. This notice may not be removed or altered from any source distribution.
  *//// A circle shape.
var b2CircleShape=function(_b2Shape){_inherits(b2CircleShape,_b2Shape);function b2CircleShape(){var radius=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;_classCallCheck(this,b2CircleShape);var _this2=_possibleConstructorReturn(this,(b2CircleShape.__proto__||Object.getPrototypeOf(b2CircleShape)).call(this,exports.b2ShapeType.e_circleShape,radius));_this2.m_p=new b2Vec2();return _this2;}_createClass(b2CircleShape,[{key:'Set',value:function Set(position){var radius=arguments.length>1&&arguments[1]!==undefined?arguments[1]:this.m_radius;this.m_p.Copy(position);this.m_radius=radius;return this;}/// Implement b2Shape.
},{key:'Clone',value:function Clone(){return new b2CircleShape().Copy(this);}},{key:'Copy',value:function Copy(other){_get(b2CircleShape.prototype.__proto__||Object.getPrototypeOf(b2CircleShape.prototype),'Copy',this).call(this,other);// DEBUG: b2Assert(other instanceof b2CircleShape);
...
var b2PolygonShape=function(_b2Shape2){_inherits(b2PolygonShape,_b2Shape2);function b2PolygonShape(){_classCallCheck(this,b2PolygonShape);var _this3=_possibleConstructorReturn(this,(b2PolygonShape.__proto__||Object.getPrototypeOf(b2PolygonShape)).call(this,exports.b2ShapeType.e_polygonShape,b2_polygonRadius));_this3.m_centroid=new b2Vec2(0,0);_this3.m_vertices=[];_this3.m_normals=[];_this3.m_count=0;return _this3;}/// Implement b2Shape.
_createClass(b2PolygonShape,[{key:'Clone',value:function Clone(){return new b2PolygonShape().Copy(this);}},{key:'Copy',value:function Copy(other){_get(b2PolygonShape.prototype.__proto__||Object.getPrototypeOf(b2PolygonShape.prototype),'Copy',this).call(this,other);// DEBUG: b2Assert(other instanceof b2PolygonShape);
...
},{key:'GetChildCount',value:function GetChildCount(){return 1;}},{key:'Set',value:function Set(vertices){var count=arguments.length>1&&arguments[1]!==undefined?arguments[1]:vertices.length;var start=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;// DEBUG: b2Assert(3 <= count);
if(count<3){return this.SetAsBox(1,1);}var n=count;// Perform welding and copy vertices into local buffer.
var ps=[];for(var i=0;i<n;++i){var/*b2Vec2*/v=vertices[start+i];var/*bool*/unique=true;for(var/*int32*/j=0;j<ps.length;++j){if(b2Vec2.DistanceSquaredVV(v,ps[j])<0.5*b2_linearSlop*(0.5*b2_linearSlop)){unique=false;break;}}if(unique){ps.push(v);}}n=ps.length;if(n<3){// Polygon is degenerate.
...
b2PolygonShape.ComputeCentroid(this.m_vertices,m,this.m_centroid);return this;}},{key:'SetAsArray',value:function SetAsArray(vertices){var count=arguments.length>1&&arguments[1]!==undefined?arguments[1]:vertices.length;return this.Set(vertices,count);}/// Build vertices to represent an axis-aligned box or an oriented box.
...
var area=0;var center=b2PolygonShape.ComputeSubmergedArea_s_center.SetZero();var p2=this.m_vertices[intoIndex2];var p3=void 0;// An awkward loop from intoIndex2+1 to outIndex2
...
},{key:'Clone',value:function Clone(){return new b2EdgeShape().Copy(this);}},{key:'Copy',value:function Copy(other){_get(b2EdgeShape.prototype.__proto__||Object.getPrototypeOf(b2EdgeShape.prototype),'Copy',this).call(this,other);// DEBUG: b2Assert(other instanceof b2EdgeShape);
...
var b2ChainShape=function(_b2Shape4){_inherits(b2ChainShape,_b2Shape4);function b2ChainShape(){_classCallCheck(this,b2ChainShape);var _this5=_possibleConstructorReturn(this,(b2ChainShape.__proto__||Object.getPrototypeOf(b2ChainShape)).call(this,exports.b2ShapeType.e_chainShape,b2_polygonRadius));_this5.m_vertices=[];_this5.m_count=0;_this5.m_prevVertex=new b2Vec2();_this5.m_nextVertex=new b2Vec2();_this5.m_hasPrevVertex=false;_this5.m_hasNextVertex=false;return _this5;}/// Create a loop. This automatically adjusts connectivity.
/// @param vertices an array of vertices, these are copied
/// @param count the vertex count
_createClass(b2ChainShape,[{key:'CreateLoop',value:function CreateLoop(vertices){var count=arguments.length>1&&arguments[1]!==undefined?arguments[1]:vertices.length;var start=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;// DEBUG: b2Assert(count >= 3);
...
// DEBUG: }
this.m_count=count+1;this.m_vertices=b2Vec2.MakeArray(this.m_count);for(var i=0;i<count;++i){this.m_vertices[i].Copy(vertices[start+i]);}this.m_vertices[count].Copy(this.m_vertices[0]);this.m_prevVertex.Copy(this.m_vertices[this.m_count-2]);this.m_nextVertex.Copy(this.m_vertices[1]);this.m_hasPrevVertex=true;this.m_hasNextVertex=true;return this;}/// Create a chain with isolated end vertices.
/// @param vertices an array of vertices, these are copied
/// @param count the vertex count
},{key:'CreateChain',value:function CreateChain(vertices){var count=arguments.length>1&&arguments[1]!==undefined?arguments[1]:vertices.length;var start=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;// DEBUG: b2Assert(count >= 2);
...
// DEBUG:   b2Assert(b2Vec2.DistanceSquaredVV(v1, v2) > b2_linearSlop * b2_linearSlop);
// DEBUG: }
this.m_count=count;this.m_vertices=b2Vec2.MakeArray(count);for(var i=0;i<count;++i){this.m_vertices[i].Copy(vertices[start+i]);}this.m_hasPrevVertex=false;this.m_hasNextVertex=false;this.m_prevVertex.SetZero();this.m_nextVertex.SetZero();return this;}/// Establish connectivity to a vertex that precedes the first vertex.
...
},{key:'Clone',value:function Clone(){return new b2ChainShape().Copy(this);}},{key:'Copy',value:function Copy(other){_get(b2ChainShape.prototype.__proto__||Object.getPrototypeOf(b2ChainShape.prototype),'Copy',this).call(this,other);// DEBUG: b2Assert(other instanceof b2ChainShape);
this.CreateChain(other.m_vertices,other.m_count);this.m_prevVertex.Copy(other.m_prevVertex);this.m_nextVertex.Copy(other.m_nextVertex);this.m_hasPrevVertex=other.m_hasPrevVertex;this.m_hasNextVertex=other.m_hasNextVertex;return this;}/// @see b2Shape::GetChildCount
...
var b2Filter=function(){function b2Filter(){_classCallCheck(this,b2Filter);/// The collision category bits. Normally you would just set one bit.
...
var b2FixtureProxy=function b2FixtureProxy(fixture){_classCallCheck(this,b2FixtureProxy);this.aabb=new b2AABB();this.childIndex=0;this.fixture=fixture;};/// A fixture is used to attach a shape to a body for collision detection. A fixture
/// inherits its transform from its parent. Fixtures hold additional non-geometric data
/// such as friction, collision filters, etc.
/// Fixtures are created via b2Body::CreateFixture.
/// @warning you cannot reuse fixtures.
var b2Fixture=function(){function b2Fixture(def,body){_classCallCheck(this,b2Fixture);this.m_density=0;this.m_next=null;this.m_friction=0;this.m_restitution=0;this.m_proxies=[];this.m_proxyCount=0;this.m_filter=new b2Filter();this.m_isSensor=false;this.m_userData=null;this.m_body=body;this.m_shape=def.shape.Clone();}/// Get the type of the child shape. You can use this to down cast to the concrete shape.
/// @return the shape type.
_createClass(b2Fixture,[{key:'GetType',value:function GetType(){return this.m_shape.GetType();}/// Get the child shape. You can modify the child shape, however you should not change the
...
var edge=this.m_body.GetContactList();while(edge){var contact=edge.contact;var fixtureA=contact.GetFixtureA();var fixtureB=contact.GetFixtureB();if(fixtureA===this||fixtureB===this){contact.FlagForFiltering();}edge=edge.next;}var world=this.m_body.GetWorld();if(world===null){return;}// Touch each proxy so that new pairs may be created
var broadPhase=world.m_contactManager.m_broadPhase;for(var i=0;i<this.m_proxyCount;++i){broadPhase.TouchProxy(this.m_proxies[i].treeNode);}}/// Get the parent body of this fixture. This is NULL if the fixture is not attached.
...
this.m_proxies=b2MakeArray(this.m_shape.GetChildCount(),function(i){return new b2FixtureProxy(_this6);});this.m_proxyCount=0;this.m_density=b2Maybe(def.density,0);}},{key:'Destroy',value:function Destroy(){}// The proxies must be destroyed before calling this.
...
},{key:'CreateProxies',value:function CreateProxies(xf){var broadPhase=this.m_body.m_world.m_contactManager.m_broadPhase;// DEBUG: b2Assert(this.m_proxyCount === 0);
// Create proxies in the broad-phase.
this.m_proxyCount=this.m_shape.GetChildCount();for(var i=0;i<this.m_proxyCount;++i){var proxy=this.m_proxies[i]=new b2FixtureProxy(this);this.m_shape.ComputeAABB(proxy.aabb,xf,i);proxy.treeNode=broadPhase.CreateProxy(proxy.aabb,proxy);proxy.childIndex=i;}}},{key:'DestroyProxies',value:function DestroyProxies(){var broadPhase=this.m_body.m_world.m_contactManager.m_broadPhase;// Destroy proxies in the broad-phase.
for(var i=0;i<this.m_proxyCount;++i){var proxy=this.m_proxies[i];delete proxy.treeNode.userData;broadPhase.DestroyProxy(proxy.treeNode);delete proxy.treeNode;}this.m_proxyCount=0;}},{key:'TouchProxies',value:function TouchProxies(){var broadPhase=this.m_body.m_world.m_contactManager.m_broadPhase;var proxyCount=this.m_proxyCount;for(var i=0;i<proxyCount;++i){broadPhase.TouchProxy(this.m_proxies[i].treeNode);}}},{key:'Synchronize',value:function Synchronize(transform1,transform2){if(this.m_proxyCount===0){return;}var broadPhase=this.m_body.m_world.m_contactManager.m_broadPhase;for(var i=0;i<this.m_proxyCount;++i){var proxy=this.m_proxies[i];// Compute an AABB that covers the swept shape (may miss some rotation effect).
var aabb1=b2Fixture.Synchronize_s_aabb1;var aabb2=b2Fixture.Synchronize_s_aabb2;this.m_shape.ComputeAABB(aabb1,transform1,i);this.m_shape.ComputeAABB(aabb2,transform2,i);proxy.aabb.Combine2(aabb1,aabb2);var displacement=b2Vec2.SubVV(transform2.p,transform1.p,b2Fixture.Synchronize_s_displacement);broadPhase.MoveProxy(proxy.treeNode,proxy.aabb,displacement);}}}]);return b2Fixture;}();b2Fixture.Synchronize_s_aabb1=new b2AABB();b2Fixture.Synchronize_s_aabb2=new b2AABB();b2Fixture.Synchronize_s_displacement=new b2Vec2();/*
...
},{key:'CreateFixtureDef',value:function CreateFixtureDef(def){if(this.m_world.IsLocked()){throw new Error();}var fixture=new b2Fixture(def,this);fixture.Create(def);if(this.m_activeFlag){fixture.CreateProxies(this.m_xf);}fixture.m_next=this.m_fixtureList;this.m_fixtureList=fixture;++this.m_fixtureCount;// fixture.m_body = this;
...
fixture.m_next=null;fixture.Destroy();--this.m_fixtureCount;// Reset the mass data.
...
this.m_xf0.Copy(this.m_xf);// #endif
b2Transform.MulXV(this.m_xf,this.m_sweep.localCenter,this.m_sweep.c);this.m_sweep.a=angle;this.m_sweep.c0.Copy(this.m_sweep.c);this.m_sweep.a0=angle;for(var f=this.m_fixtureList;f;f=f.m_next){f.Synchronize(this.m_xf,this.m_xf);}this.m_world.m_contactManager.FindNewContacts();}},{key:'SetTransform',value:function SetTransform(xf){this.SetTransformVec(xf.p,xf.GetAngle());}/// Get the body transform for the body's origin.
...
for(var f=this.m_fixtureList;f;f=f.m_next){f.CreateProxies(this.m_xf);}// Contacts are created the next time step.
...
b2Body.ResetMassData_s_localCenter=new b2Vec2();b2Body.ResetMassData_s_oldCenter=new b2Vec2();b2Body.ResetMassData_s_massData=new b2MassData();b2Body.SynchronizeFixtures_s_xf1=new b2Transform();/*
...
var b2JointEdge=function b2JointEdge(joint,other){_classCallCheck(this,b2JointEdge);this.prev=null;///< the previous joint edge in the body's joint list
this.next=null;///< the next joint edge in the body's joint list
this.joint=joint;this.other=other;};/// Joint definitions are used to construct joints.
...
var b2Joint=function(){function b2Joint(def){_classCallCheck(this,b2Joint);// DEBUG: b2Assert(def.bodyA !== def.bodyB);
this.m_type=exports.b2JointType.e_unknownJoint;this.m_prev=null;this.m_next=null;this.m_index=0;this.m_islandFlag=false;this.m_collideConnected=false;this.m_userData=null;this.m_type=def.type;this.m_edgeA=new b2JointEdge(this,def.bodyB);this.m_edgeB=new b2JointEdge(this,def.bodyA);this.m_bodyA=def.bodyA;this.m_bodyB=def.bodyB;this.m_collideConnected=b2Maybe(def.collideConnected,false);this.m_userData=def.userData;}/// Get the type of the concrete joint.
...
var b2FrictionJointDef=function(_b2JointDef3){_inherits(b2FrictionJointDef,_b2JointDef3);function b2FrictionJointDef(){_classCallCheck(this,b2FrictionJointDef);var _this11=_possibleConstructorReturn(this,(b2FrictionJointDef.__proto__||Object.getPrototypeOf(b2FrictionJointDef)).call(this,exports.b2JointType.e_frictionJoint));_this11.localAnchorA=new b2Vec2();_this11.localAnchorB=new b2Vec2();_this11.maxForce=0;_this11.maxTorque=0;return _this11;}_createClass(b2FrictionJointDef,[{key:'Initialize',value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);}}]);return b2FrictionJointDef;}(b2JointDef);var b2FrictionJoint=function(_b2Joint3){_inherits(b2FrictionJoint,_b2Joint3);function b2FrictionJoint(def){_classCallCheck(this,b2FrictionJoint);var _this12=_possibleConstructorReturn(this,(b2FrictionJoint.__proto__||Object.getPrototypeOf(b2FrictionJoint)).call(this,def));_this12.m_localAnchorA=new b2Vec2();_this12.m_localAnchorB=new b2Vec2();// Solver shared
_this12.m_linearImpulse=new b2Vec2();_this12.m_angularImpulse=0;_this12.m_maxForce=0;_this12.m_maxTorque=0;// Solver temp
_this12.m_indexA=0;_this12.m_indexB=0;_this12.m_rA=new b2Vec2();_this12.m_rB=new b2Vec2();_this12.m_localCenterA=new b2Vec2();_this12.m_localCenterB=new b2Vec2();_this12.m_invMassA=0;_this12.m_invMassB=0;_this12.m_invIA=0;_this12.m_invIB=0;_this12.m_linearMass=new b2Mat22();_this12.m_angularMass=0;_this12.m_qA=new b2Rot();_this12.m_qB=new b2Rot();_this12.m_lalcA=new b2Vec2();_this12.m_lalcB=new b2Vec2();_this12.m_K=new b2Mat22();_this12.m_localAnchorA.Copy(def.localAnchorA);_this12.m_localAnchorB.Copy(def.localAnchorB);_this12.m_linearImpulse.SetZero();_this12.m_maxForce=b2Maybe(def.maxForce,0);_this12.m_maxTorque=b2Maybe(def.maxTorque,0);_this12.m_linearMass.SetZero();return _this12;}_createClass(b2FrictionJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;// const cA: b2Vec2 = data.positions[this.m_indexA].c;
...
var b2GearJointDef=function(_b2JointDef4){_inherits(b2GearJointDef,_b2JointDef4);function b2GearJointDef(){_classCallCheck(this,b2GearJointDef);var _this13=_possibleConstructorReturn(this,(b2GearJointDef.__proto__||Object.getPrototypeOf(b2GearJointDef)).call(this,exports.b2JointType.e_gearJoint));_this13.ratio=1;return _this13;}return b2GearJointDef;}(b2JointDef);var b2GearJoint=function(_b2Joint4){_inherits(b2GearJoint,_b2Joint4);function b2GearJoint(def){_classCallCheck(this,b2GearJoint);var _this14=_possibleConstructorReturn(this,(b2GearJoint.__proto__||Object.getPrototypeOf(b2GearJoint)).call(this,def));_this14.m_typeA=exports.b2JointType.e_unknownJoint;_this14.m_typeB=exports.b2JointType.e_unknownJoint;// Solver shared
_this14.m_localAnchorA=new b2Vec2();_this14.m_localAnchorB=new b2Vec2();_this14.m_localAnchorC=new b2Vec2();_this14.m_localAnchorD=new b2Vec2();_this14.m_localAxisC=new b2Vec2();_this14.m_localAxisD=new b2Vec2();_this14.m_referenceAngleA=0;_this14.m_referenceAngleB=0;_this14.m_constant=0;_this14.m_ratio=0;_this14.m_impulse=0;// Solver temp
_this14.m_indexA=0;_this14.m_indexB=0;_this14.m_indexC=0;_this14.m_indexD=0;_this14.m_lcA=new b2Vec2();_this14.m_lcB=new b2Vec2();_this14.m_lcC=new b2Vec2();_this14.m_lcD=new b2Vec2();_this14.m_mA=0;_this14.m_mB=0;_this14.m_mC=0;_this14.m_mD=0;_this14.m_iA=0;_this14.m_iB=0;_this14.m_iC=0;_this14.m_iD=0;_this14.m_JvAC=new b2Vec2();_this14.m_JvBD=new b2Vec2();_this14.m_JwA=0;_this14.m_JwB=0;_this14.m_JwC=0;_this14.m_JwD=0;_this14.m_mass=0;_this14.m_qA=new b2Rot();_this14.m_qB=new b2Rot();_this14.m_qC=new b2Rot();_this14.m_qD=new b2Rot();_this14.m_lalcA=new b2Vec2();_this14.m_lalcB=new b2Vec2();_this14.m_lalcC=new b2Vec2();_this14.m_lalcD=new b2Vec2();_this14.m_joint1=def.joint1;_this14.m_joint2=def.joint2;_this14.m_typeA=_this14.m_joint1.GetType();_this14.m_typeB=_this14.m_joint2.GetType();// DEBUG: b2Assert(this.m_typeA === b2JointType.e_revoluteJoint || this.m_typeA === b2JointType.e_prismaticJoint);
// DEBUG: b2Assert(this.m_typeB === b2JointType.e_revoluteJoint || this.m_typeB === b2JointType.e_prismaticJoint);
var coordinateA=void 0,coordinateB=void 0;// TODO_ERIN there might be some problem with the joint edges in b2Joint.
_this14.m_bodyC=_this14.m_joint1.GetBodyA();_this14.m_bodyA=_this14.m_joint1.GetBodyB();// Get geometry of joint1
var xfA=_this14.m_bodyA.m_xf;var aA=_this14.m_bodyA.m_sweep.a;var xfC=_this14.m_bodyC.m_xf;var aC=_this14.m_bodyC.m_sweep.a;if(_this14.m_typeA===exports.b2JointType.e_revoluteJoint){var revolute=def.joint1;_this14.m_localAnchorC.Copy(revolute.m_localAnchorA);_this14.m_localAnchorA.Copy(revolute.m_localAnchorB);_this14.m_referenceAngleA=revolute.m_referenceAngle;_this14.m_localAxisC.SetZero();coordinateA=aA-aC-_this14.m_referenceAngleA;}else{var prismatic=def.joint1;_this14.m_localAnchorC.Copy(prismatic.m_localAnchorA);_this14.m_localAnchorA.Copy(prismatic.m_localAnchorB);_this14.m_referenceAngleA=prismatic.m_referenceAngle;_this14.m_localAxisC.Copy(prismatic.m_localXAxisA);// b2Vec2 pC = m_localAnchorC;
var pC=_this14.m_localAnchorC;// b2Vec2 pA = b2MulT(xfC.q, b2Mul(xfA.q, m_localAnchorA) + (xfA.p - xfC.p));
var pA=b2Rot.MulTRV(xfC.q,b2Vec2.AddVV(b2Rot.MulRV(xfA.q,_this14.m_localAnchorA,b2Vec2.s_t0),b2Vec2.SubVV(xfA.p,xfC.p,b2Vec2.s_t1),b2Vec2.s_t0),b2Vec2.s_t0);// pA uses s_t0
// coordinateA = b2Dot(pA - pC, m_localAxisC);
coordinateA=b2Vec2.DotVV(b2Vec2.SubVV(pA,pC,b2Vec2.s_t0),_this14.m_localAxisC);}_this14.m_bodyD=_this14.m_joint2.GetBodyA();_this14.m_bodyB=_this14.m_joint2.GetBodyB();// Get geometry of joint2
var xfB=_this14.m_bodyB.m_xf;var aB=_this14.m_bodyB.m_sweep.a;var xfD=_this14.m_bodyD.m_xf;var aD=_this14.m_bodyD.m_sweep.a;if(_this14.m_typeB===exports.b2JointType.e_revoluteJoint){var _revolute=def.joint2;_this14.m_localAnchorD.Copy(_revolute.m_localAnchorA);_this14.m_localAnchorB.Copy(_revolute.m_localAnchorB);_this14.m_referenceAngleB=_revolute.m_referenceAngle;_this14.m_localAxisD.SetZero();coordinateB=aB-aD-_this14.m_referenceAngleB;}else{var _prismatic=def.joint2;_this14.m_localAnchorD.Copy(_prismatic.m_localAnchorA);_this14.m_localAnchorB.Copy(_prismatic.m_localAnchorB);_this14.m_referenceAngleB=_prismatic.m_referenceAngle;_this14.m_localAxisD.Copy(_prismatic.m_localXAxisA);// b2Vec2 pD = m_localAnchorD;
var pD=_this14.m_localAnchorD;// b2Vec2 pB = b2MulT(xfD.q, b2Mul(xfB.q, m_localAnchorB) + (xfB.p - xfD.p));
var pB=b2Rot.MulTRV(xfD.q,b2Vec2.AddVV(b2Rot.MulRV(xfB.q,_this14.m_localAnchorB,b2Vec2.s_t0),b2Vec2.SubVV(xfB.p,xfD.p,b2Vec2.s_t1),b2Vec2.s_t0),b2Vec2.s_t0);// pB uses s_t0
// coordinateB = b2Dot(pB - pD, m_localAxisD);
coordinateB=b2Vec2.DotVV(b2Vec2.SubVV(pB,pD,b2Vec2.s_t0),_this14.m_localAxisD);}_this14.m_ratio=b2Maybe(def.ratio,1);_this14.m_constant=coordinateA+_this14.m_ratio*coordinateB;_this14.m_impulse=0;return _this14;}_createClass(b2GearJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_indexC=this.m_bodyC.m_islandIndex;this.m_indexD=this.m_bodyD.m_islandIndex;this.m_lcA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_lcB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_lcC.Copy(this.m_bodyC.m_sweep.localCenter);this.m_lcD.Copy(this.m_bodyD.m_sweep.localCenter);this.m_mA=this.m_bodyA.m_invMass;this.m_mB=this.m_bodyB.m_invMass;this.m_mC=this.m_bodyC.m_invMass;this.m_mD=this.m_bodyD.m_invMass;this.m_iA=this.m_bodyA.m_invI;this.m_iB=this.m_bodyB.m_invI;this.m_iC=this.m_bodyC.m_invI;this.m_iD=this.m_bodyD.m_invI;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var aC=data.positions[this.m_indexC].a;var vC=data.velocities[this.m_indexC].v;var wC=data.velocities[this.m_indexC].w;var aD=data.positions[this.m_indexD].a;var vD=data.velocities[this.m_indexD].v;var wD=data.velocities[this.m_indexD].w;// b2Rot qA(aA), qB(aB), qC(aC), qD(aD);
...
var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB),qC=this.m_qC.SetAngle(aC),qD=this.m_qD.SetAngle(aD);var linearError=0;var coordinateA=void 0,coordinateB=void 0;var JvAC=this.m_JvAC,JvBD=this.m_JvBD;var JwA=void 0,JwB=void 0,JwC=void 0,JwD=void 0;var mass=0;if(this.m_typeA===exports.b2JointType.e_revoluteJoint){JvAC.SetZero();JwA=1;JwC=1;mass+=this.m_iA+this.m_iC;coordinateA=aA-aC-this.m_referenceAngleA;}else{// b2Vec2 u = b2Mul(qC, m_localAxisC);
...
this.m_ratio=ratio;}},{key:'Dump',value:function Dump(log){var indexA=this.m_bodyA.m_islandIndex;var indexB=this.m_bodyB.m_islandIndex;var index1=this.m_joint1.m_index;var index2=this.m_joint2.m_index;log("  const jd: b2GearJointDef = new b2GearJointDef();\n");log("  jd.bodyA = bodies[%d];\n",indexA);log("  jd.bodyB = bodies[%d];\n",indexB);log("  jd.collideConnected = %s;\n",this.m_collideConnected?"true":"false");log("  jd.joint1 = joints[%d];\n",index1);log("  jd.joint2 = joints[%d];\n",index2);log("  jd.ratio = %.15f;\n",this.m_ratio);log("  joints[%d] = this.m_world.CreateJoint(jd);\n",this.m_index);}}]);return b2GearJoint;}(b2Joint);b2GearJoint.InitVelocityConstraints_s_u=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rA=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rB=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rC=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rD=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_u=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rA=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rB=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rC=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rD=new b2Vec2();/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2MotorJointDef=function(_b2JointDef5){_inherits(b2MotorJointDef,_b2JointDef5);function b2MotorJointDef(){_classCallCheck(this,b2MotorJointDef);var _this15=_possibleConstructorReturn(this,(b2MotorJointDef.__proto__||Object.getPrototypeOf(b2MotorJointDef)).call(this,exports.b2JointType.e_motorJoint));_this15.linearOffset=new b2Vec2(0,0);_this15.angularOffset=0;_this15.maxForce=1;_this15.maxTorque=1;_this15.correctionFactor=0.3;return _this15;}_createClass(b2MotorJointDef,[{key:'Initialize',value:function Initialize(bA,bB){this.bodyA=bA;this.bodyB=bB;// b2Vec2 xB = bodyB->GetPosition();
// linearOffset = bodyA->GetLocalPoint(xB);
this.bodyA.GetLocalPoint(this.bodyB.GetPosition(),this.linearOffset);var angleA=this.bodyA.GetAngle();var angleB=this.bodyB.GetAngle();this.angularOffset=angleB-angleA;}}]);return b2MotorJointDef;}(b2JointDef);var b2MotorJoint=function(_b2Joint5){_inherits(b2MotorJoint,_b2Joint5);function b2MotorJoint(def){_classCallCheck(this,b2MotorJoint);// Solver shared
var _this16=_possibleConstructorReturn(this,(b2MotorJoint.__proto__||Object.getPrototypeOf(b2MotorJoint)).call(this,def));_this16.m_linearOffset=new b2Vec2();_this16.m_angularOffset=0;_this16.m_linearImpulse=new b2Vec2();_this16.m_angularImpulse=0;_this16.m_maxForce=0;_this16.m_maxTorque=0;_this16.m_correctionFactor=0.3;// Solver temp
_this16.m_indexA=0;_this16.m_indexB=0;_this16.m_rA=new b2Vec2();_this16.m_rB=new b2Vec2();_this16.m_localCenterA=new b2Vec2();_this16.m_localCenterB=new b2Vec2();_this16.m_linearError=new b2Vec2();_this16.m_angularError=0;_this16.m_invMassA=0;_this16.m_invMassB=0;_this16.m_invIA=0;_this16.m_invIB=0;_this16.m_linearMass=new b2Mat22();_this16.m_angularMass=0;_this16.m_qA=new b2Rot();_this16.m_qB=new b2Rot();_this16.m_K=new b2Mat22();_this16.m_linearOffset.Copy(b2Maybe(def.linearOffset,b2Vec2.ZERO));_this16.m_linearImpulse.SetZero();_this16.m_maxForce=b2Maybe(def.maxForce,0);_this16.m_maxTorque=b2Maybe(def.maxTorque,0);_this16.m_correctionFactor=b2Maybe(def.correctionFactor,0.3);return _this16;}_createClass(b2MotorJoint,[{key:'GetAnchorA',value:function GetAnchorA(out){var pos=this.m_bodyA.GetPosition();out.x=pos.x;out.y=pos.y;return out;}},{key:'GetAnchorB',value:function GetAnchorB(out){var pos=this.m_bodyB.GetPosition();out.x=pos.x;out.y=pos.y;return out;}},{key:'GetReactionForce',value:function GetReactionForce(inv_dt,out){// return inv_dt * m_linearImpulse;
...
var b2MouseJointDef=function(_b2JointDef6){_inherits(b2MouseJointDef,_b2JointDef6);function b2MouseJointDef(){_classCallCheck(this,b2MouseJointDef);var _this17=_possibleConstructorReturn(this,(b2MouseJointDef.__proto__||Object.getPrototypeOf(b2MouseJointDef)).call(this,exports.b2JointType.e_mouseJoint));_this17.target=new b2Vec2();_this17.maxForce=0;_this17.frequencyHz=5;_this17.dampingRatio=0.7;return _this17;}return b2MouseJointDef;}(b2JointDef);var b2MouseJoint=function(_b2Joint6){_inherits(b2MouseJoint,_b2Joint6);function b2MouseJoint(def){_classCallCheck(this,b2MouseJoint);var _this18=_possibleConstructorReturn(this,(b2MouseJoint.__proto__||Object.getPrototypeOf(b2MouseJoint)).call(this,def));_this18.m_localAnchorB=new b2Vec2();_this18.m_targetA=new b2Vec2();_this18.m_frequencyHz=0;_this18.m_dampingRatio=0;_this18.m_beta=0;// Solver shared
_this18.m_impulse=new b2Vec2();_this18.m_maxForce=0;_this18.m_gamma=0;// Solver temp
_this18.m_indexA=0;_this18.m_indexB=0;_this18.m_rB=new b2Vec2();_this18.m_localCenterB=new b2Vec2();_this18.m_invMassB=0;_this18.m_invIB=0;_this18.m_mass=new b2Mat22();_this18.m_C=new b2Vec2();_this18.m_qB=new b2Rot();_this18.m_lalcB=new b2Vec2();_this18.m_K=new b2Mat22();_this18.m_targetA.Copy(b2Maybe(def.target,b2Vec2.ZERO));// DEBUG: b2Assert(this.m_targetA.IsValid());
b2Transform.MulTXV(_this18.m_bodyB.GetTransform(),_this18.m_targetA,_this18.m_localAnchorB);_this18.m_maxForce=b2Maybe(def.maxForce,0);// DEBUG: b2Assert(b2IsValid(this.m_maxForce) && this.m_maxForce >= 0);
_this18.m_impulse.SetZero();_this18.m_frequencyHz=b2Maybe(def.frequencyHz,0);// DEBUG: b2Assert(b2IsValid(this.m_frequencyHz) && this.m_frequencyHz >= 0);
_this18.m_dampingRatio=b2Maybe(def.dampingRatio,0);// DEBUG: b2Assert(b2IsValid(this.m_dampingRatio) && this.m_dampingRatio >= 0);
_this18.m_beta=0;_this18.m_gamma=0;return _this18;}_createClass(b2MouseJoint,[{key:'SetTarget',value:function SetTarget(target){if(!this.m_bodyB.IsAwake()){this.m_bodyB.SetAwake(true);}this.m_targetA.Copy(target);}},{key:'GetTarget',value:function GetTarget(){return this.m_targetA;}},{key:'SetMaxForce',value:function SetMaxForce(maxForce){this.m_maxForce=maxForce;}},{key:'GetMaxForce',value:function GetMaxForce(){return this.m_maxForce;}},{key:'SetFrequency',value:function SetFrequency(hz){this.m_frequencyHz=hz;}},{key:'GetFrequency',value:function GetFrequency(){return this.m_frequencyHz;}},{key:'SetDampingRatio',value:function SetDampingRatio(ratio){this.m_dampingRatio=ratio;}},{key:'GetDampingRatio',value:function GetDampingRatio(){return this.m_dampingRatio;}},{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIB=this.m_bodyB.m_invI;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qB=this.m_qB.SetAngle(aB);var mass=this.m_bodyB.GetMass();// Frequency
var omega=2*b2_pi*this.m_frequencyHz;// Damping coefficient
...
var b2PrismaticJointDef=function(_b2JointDef7){_inherits(b2PrismaticJointDef,_b2JointDef7);function b2PrismaticJointDef(){_classCallCheck(this,b2PrismaticJointDef);var _this19=_possibleConstructorReturn(this,(b2PrismaticJointDef.__proto__||Object.getPrototypeOf(b2PrismaticJointDef)).call(this,exports.b2JointType.e_prismaticJoint));_this19.localAnchorA=new b2Vec2();_this19.localAnchorB=new b2Vec2();_this19.localAxisA=new b2Vec2(1,0);_this19.referenceAngle=0;_this19.enableLimit=false;_this19.lowerTranslation=0;_this19.upperTranslation=0;_this19.enableMotor=false;_this19.maxMotorForce=0;_this19.motorSpeed=0;return _this19;}_createClass(b2PrismaticJointDef,[{key:'Initialize',value:function Initialize(bA,bB,anchor,axis){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.bodyA.GetLocalVector(axis,this.localAxisA);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2PrismaticJointDef;}(b2JointDef);var b2PrismaticJoint=function(_b2Joint7){_inherits(b2PrismaticJoint,_b2Joint7);function b2PrismaticJoint(def){_classCallCheck(this,b2PrismaticJoint);// Solver shared
var _this20=_possibleConstructorReturn(this,(b2PrismaticJoint.__proto__||Object.getPrototypeOf(b2PrismaticJoint)).call(this,def));_this20.m_localAnchorA=new b2Vec2();_this20.m_localAnchorB=new b2Vec2();_this20.m_localXAxisA=new b2Vec2();_this20.m_localYAxisA=new b2Vec2();_this20.m_referenceAngle=0;_this20.m_impulse=new b2Vec3(0,0,0);_this20.m_motorImpulse=0;_this20.m_lowerTranslation=0;_this20.m_upperTranslation=0;_this20.m_maxMotorForce=0;_this20.m_motorSpeed=0;_this20.m_enableLimit=false;_this20.m_enableMotor=false;_this20.m_limitState=exports.b2LimitState.e_inactiveLimit;// Solver temp
_this20.m_indexA=0;_this20.m_indexB=0;_this20.m_localCenterA=new b2Vec2();_this20.m_localCenterB=new b2Vec2();_this20.m_invMassA=0;_this20.m_invMassB=0;_this20.m_invIA=0;_this20.m_invIB=0;_this20.m_axis=new b2Vec2(0,0);_this20.m_perp=new b2Vec2(0,0);_this20.m_s1=0;_this20.m_s2=0;_this20.m_a1=0;_this20.m_a2=0;_this20.m_K=new b2Mat33();_this20.m_K3=new b2Mat33();_this20.m_K2=new b2Mat22();_this20.m_motorMass=0;_this20.m_qA=new b2Rot();_this20.m_qB=new b2Rot();_this20.m_lalcA=new b2Vec2();_this20.m_lalcB=new b2Vec2();_this20.m_rA=new b2Vec2();_this20.m_rB=new b2Vec2();_this20.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,b2Vec2.ZERO));_this20.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,b2Vec2.ZERO));_this20.m_localXAxisA.Copy(b2Maybe(def.localAxisA,new b2Vec2(1,0))).SelfNormalize();b2Vec2.CrossOneV(_this20.m_localXAxisA,_this20.m_localYAxisA);_this20.m_referenceAngle=b2Maybe(def.referenceAngle,0);_this20.m_lowerTranslation=b2Maybe(def.lowerTranslation,0);_this20.m_upperTranslation=b2Maybe(def.upperTranslation,0);_this20.m_maxMotorForce=b2Maybe(def.maxMotorForce,0);_this20.m_motorSpeed=b2Maybe(def.motorSpeed,0);_this20.m_enableLimit=b2Maybe(def.enableLimit,false);_this20.m_enableMotor=b2Maybe(def.enableMotor,false);return _this20;}_createClass(b2PrismaticJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// Compute the effective masses.
...
var b2PulleyJointDef=function(_b2JointDef8){_inherits(b2PulleyJointDef,_b2JointDef8);function b2PulleyJointDef(){_classCallCheck(this,b2PulleyJointDef);var _this21=_possibleConstructorReturn(this,(b2PulleyJointDef.__proto__||Object.getPrototypeOf(b2PulleyJointDef)).call(this,exports.b2JointType.e_pulleyJoint));_this21.groundAnchorA=new b2Vec2(-1,1);_this21.groundAnchorB=new b2Vec2(1,1);_this21.localAnchorA=new b2Vec2(-1,0);_this21.localAnchorB=new b2Vec2(1,0);_this21.lengthA=0;_this21.lengthB=0;_this21.ratio=1;_this21.collideConnected=true;return _this21;}_createClass(b2PulleyJointDef,[{key:'Initialize',value:function Initialize(bA,bB,groundA,groundB,anchorA,anchorB,r){this.bodyA=bA;this.bodyB=bB;this.groundAnchorA.Copy(groundA);this.groundAnchorB.Copy(groundB);this.bodyA.GetLocalPoint(anchorA,this.localAnchorA);this.bodyB.GetLocalPoint(anchorB,this.localAnchorB);this.lengthA=b2Vec2.DistanceVV(anchorA,groundA);this.lengthB=b2Vec2.DistanceVV(anchorB,groundB);this.ratio=r;// DEBUG: b2Assert(this.ratio > b2_epsilon);
}}]);return b2PulleyJointDef;}(b2JointDef);var b2PulleyJoint=function(_b2Joint8){_inherits(b2PulleyJoint,_b2Joint8);function b2PulleyJoint(def){_classCallCheck(this,b2PulleyJoint);var _this22=_possibleConstructorReturn(this,(b2PulleyJoint.__proto__||Object.getPrototypeOf(b2PulleyJoint)).call(this,def));_this22.m_groundAnchorA=new b2Vec2();_this22.m_groundAnchorB=new b2Vec2();_this22.m_lengthA=0;_this22.m_lengthB=0;// Solver shared
_this22.m_localAnchorA=new b2Vec2();_this22.m_localAnchorB=new b2Vec2();_this22.m_constant=0;_this22.m_ratio=0;_this22.m_impulse=0;// Solver temp
_this22.m_indexA=0;_this22.m_indexB=0;_this22.m_uA=new b2Vec2();_this22.m_uB=new b2Vec2();_this22.m_rA=new b2Vec2();_this22.m_rB=new b2Vec2();_this22.m_localCenterA=new b2Vec2();_this22.m_localCenterB=new b2Vec2();_this22.m_invMassA=0;_this22.m_invMassB=0;_this22.m_invIA=0;_this22.m_invIB=0;_this22.m_mass=0;_this22.m_qA=new b2Rot();_this22.m_qB=new b2Rot();_this22.m_lalcA=new b2Vec2();_this22.m_lalcB=new b2Vec2();_this22.m_groundAnchorA.Copy(b2Maybe(def.groundAnchorA,new b2Vec2(-1,1)));_this22.m_groundAnchorB.Copy(b2Maybe(def.groundAnchorB,new b2Vec2(1,0)));_this22.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,new b2Vec2(-1,0)));_this22.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,new b2Vec2(1,0)));_this22.m_lengthA=b2Maybe(def.lengthA,0);_this22.m_lengthB=b2Maybe(def.lengthB,0);// DEBUG: b2Assert(b2Maybe(def.ratio, 1) !== 0);
_this22.m_ratio=b2Maybe(def.ratio,1);_this22.m_constant=b2Maybe(def.lengthA,0)+_this22.m_ratio*b2Maybe(def.lengthB,0);_this22.m_impulse=0;return _this22;}_createClass(b2PulleyJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;// b2Rot qA(aA), qB(aB);
var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
...
var b2RevoluteJointDef=function(_b2JointDef9){_inherits(b2RevoluteJointDef,_b2JointDef9);function b2RevoluteJointDef(){_classCallCheck(this,b2RevoluteJointDef);var _this23=_possibleConstructorReturn(this,(b2RevoluteJointDef.__proto__||Object.getPrototypeOf(b2RevoluteJointDef)).call(this,exports.b2JointType.e_revoluteJoint));_this23.localAnchorA=new b2Vec2(0,0);_this23.localAnchorB=new b2Vec2(0,0);_this23.referenceAngle=0;_this23.enableLimit=false;_this23.lowerAngle=0;_this23.upperAngle=0;_this23.enableMotor=false;_this23.motorSpeed=0;_this23.maxMotorTorque=0;return _this23;}_createClass(b2RevoluteJointDef,[{key:'Initialize',value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2RevoluteJointDef;}(b2JointDef);var b2RevoluteJoint=function(_b2Joint9){_inherits(b2RevoluteJoint,_b2Joint9);function b2RevoluteJoint(def){_classCallCheck(this,b2RevoluteJoint);// Solver shared
var _this24=_possibleConstructorReturn(this,(b2RevoluteJoint.__proto__||Object.getPrototypeOf(b2RevoluteJoint)).call(this,def));_this24.m_localAnchorA=new b2Vec2();_this24.m_localAnchorB=new b2Vec2();_this24.m_impulse=new b2Vec3();_this24.m_motorImpulse=0;_this24.m_enableMotor=false;_this24.m_maxMotorTorque=0;_this24.m_motorSpeed=0;_this24.m_enableLimit=false;_this24.m_referenceAngle=0;_this24.m_lowerAngle=0;_this24.m_upperAngle=0;// Solver temp
_this24.m_indexA=0;_this24.m_indexB=0;_this24.m_rA=new b2Vec2();_this24.m_rB=new b2Vec2();_this24.m_localCenterA=new b2Vec2();_this24.m_localCenterB=new b2Vec2();_this24.m_invMassA=0;_this24.m_invMassB=0;_this24.m_invIA=0;_this24.m_invIB=0;_this24.m_mass=new b2Mat33();// effective mass for point-to-point constraint.
_this24.m_motorMass=0;// effective mass for motor/limit angular constraint.
_this24.m_limitState=exports.b2LimitState.e_inactiveLimit;_this24.m_qA=new b2Rot();_this24.m_qB=new b2Rot();_this24.m_lalcA=new b2Vec2();_this24.m_lalcB=new b2Vec2();_this24.m_K=new b2Mat22();_this24.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,b2Vec2.ZERO));_this24.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,b2Vec2.ZERO));_this24.m_referenceAngle=b2Maybe(def.referenceAngle,0);_this24.m_impulse.SetZero();_this24.m_motorImpulse=0;_this24.m_lowerAngle=b2Maybe(def.lowerAngle,0);_this24.m_upperAngle=b2Maybe(def.upperAngle,0);_this24.m_maxMotorTorque=b2Maybe(def.maxMotorTorque,0);_this24.m_motorSpeed=b2Maybe(def.motorSpeed,0);_this24.m_enableLimit=b2Maybe(def.enableLimit,false);_this24.m_enableMotor=b2Maybe(def.enableMotor,false);_this24.m_limitState=exports.b2LimitState.e_inactiveLimit;return _this24;}_createClass(b2RevoluteJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;// b2Rot qA(aA), qB(aB);
var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
...
var b2RopeJointDef=function(_b2JointDef10){_inherits(b2RopeJointDef,_b2JointDef10);function b2RopeJointDef(){_classCallCheck(this,b2RopeJointDef);var _this25=_possibleConstructorReturn(this,(b2RopeJointDef.__proto__||Object.getPrototypeOf(b2RopeJointDef)).call(this,exports.b2JointType.e_ropeJoint));_this25.localAnchorA=new b2Vec2(-1,0);_this25.localAnchorB=new b2Vec2(1,0);_this25.maxLength=0;return _this25;}return b2RopeJointDef;}(b2JointDef);var b2RopeJoint=function(_b2Joint10){_inherits(b2RopeJoint,_b2Joint10);function b2RopeJoint(def){_classCallCheck(this,b2RopeJoint);// Solver shared
var _this26=_possibleConstructorReturn(this,(b2RopeJoint.__proto__||Object.getPrototypeOf(b2RopeJoint)).call(this,def));_this26.m_localAnchorA=new b2Vec2();_this26.m_localAnchorB=new b2Vec2();_this26.m_maxLength=0;_this26.m_length=0;_this26.m_impulse=0;// Solver temp
_this26.m_indexA=0;_this26.m_indexB=0;_this26.m_u=new b2Vec2();_this26.m_rA=new b2Vec2();_this26.m_rB=new b2Vec2();_this26.m_localCenterA=new b2Vec2();_this26.m_localCenterB=new b2Vec2();_this26.m_invMassA=0;_this26.m_invMassB=0;_this26.m_invIA=0;_this26.m_invIB=0;_this26.m_mass=0;_this26.m_state=exports.b2LimitState.e_inactiveLimit;_this26.m_qA=new b2Rot();_this26.m_qB=new b2Rot();_this26.m_lalcA=new b2Vec2();_this26.m_lalcB=new b2Vec2();_this26.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,new b2Vec2(-1,0)));_this26.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,new b2Vec2(1,0)));_this26.m_maxLength=b2Maybe(def.maxLength,0);return _this26;}_createClass(b2RopeJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// this.m_rA = b2Mul(qA, this.m_localAnchorA - this.m_localCenterA);
...
var b2WeldJointDef=function(_b2JointDef11){_inherits(b2WeldJointDef,_b2JointDef11);function b2WeldJointDef(){_classCallCheck(this,b2WeldJointDef);var _this27=_possibleConstructorReturn(this,(b2WeldJointDef.__proto__||Object.getPrototypeOf(b2WeldJointDef)).call(this,exports.b2JointType.e_weldJoint));_this27.localAnchorA=new b2Vec2();_this27.localAnchorB=new b2Vec2();_this27.referenceAngle=0;_this27.frequencyHz=0;_this27.dampingRatio=0;return _this27;}_createClass(b2WeldJointDef,[{key:'Initialize',value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2WeldJointDef;}(b2JointDef);var b2WeldJoint=function(_b2Joint11){_inherits(b2WeldJoint,_b2Joint11);function b2WeldJoint(def){_classCallCheck(this,b2WeldJoint);var _this28=_possibleConstructorReturn(this,(b2WeldJoint.__proto__||Object.getPrototypeOf(b2WeldJoint)).call(this,def));_this28.m_frequencyHz=0;_this28.m_dampingRatio=0;_this28.m_bias=0;// Solver shared
_this28.m_localAnchorA=new b2Vec2();_this28.m_localAnchorB=new b2Vec2();_this28.m_referenceAngle=0;_this28.m_gamma=0;_this28.m_impulse=new b2Vec3(0,0,0);// Solver temp
_this28.m_indexA=0;_this28.m_indexB=0;_this28.m_rA=new b2Vec2();_this28.m_rB=new b2Vec2();_this28.m_localCenterA=new b2Vec2();_this28.m_localCenterB=new b2Vec2();_this28.m_invMassA=0;_this28.m_invMassB=0;_this28.m_invIA=0;_this28.m_invIB=0;_this28.m_mass=new b2Mat33();_this28.m_qA=new b2Rot();_this28.m_qB=new b2Rot();_this28.m_lalcA=new b2Vec2();_this28.m_lalcB=new b2Vec2();_this28.m_K=new b2Mat33();_this28.m_frequencyHz=b2Maybe(def.frequencyHz,0);_this28.m_dampingRatio=b2Maybe(def.dampingRatio,0);_this28.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,b2Vec2.ZERO));_this28.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,b2Vec2.ZERO));_this28.m_referenceAngle=b2Maybe(def.referenceAngle,0);_this28.m_impulse.SetZero();return _this28;}_createClass(b2WeldJoint,[{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
b2Vec2.SubVV(this.m_localAnchorB,this.m_localCenterB,this.m_lalcB);b2Rot.MulRV(qB,this.m_lalcB,this.m_rB);// J = [-I -r1_skew I r2_skew]
//     [ 0       -1 0       1]
// r_skew = [-ry; rx]
...
data.velocities[this.m_indexB].w=wB;}},{key:'SolvePositionConstraints',value:function SolvePositionConstraints(data){var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);var mA=this.m_invMassA,mB=this.m_invMassB;var iA=this.m_invIA,iB=this.m_invIB;// b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);var rA=b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
b2Vec2.SubVV(this.m_localAnchorB,this.m_localCenterB,this.m_lalcB);var rB=b2Rot.MulRV(qB,this.m_lalcB,this.m_rB);var positionError=void 0,angularError=void 0;var K=this.m_K;K.ex.x=mA+mB+rA.y*rA.y*iA+rB.y*rB.y*iB;K.ey.x=-rA.y*rA.x*iA-rB.y*rB.x*iB;K.ez.x=-rA.y*iA-rB.y*iB;K.ex.y=K.ey.x;K.ey.y=mA+mB+rA.x*rA.x*iA+rB.x*rB.x*iB;K.ez.y=rA.x*iA+rB.x*iB;K.ex.z=K.ez.x;K.ey.z=K.ez.y;K.ez.z=iA+iB;if(this.m_frequencyHz>0){// b2Vec2 C1 =  cB + rB - cA - rA;
...
/// when the local anchor points coincide in world space. Using local
/// anchors and a local axis helps when saving and loading a game.
var b2WheelJointDef=function(_b2JointDef12){_inherits(b2WheelJointDef,_b2JointDef12);function b2WheelJointDef(){_classCallCheck(this,b2WheelJointDef);var _this29=_possibleConstructorReturn(this,(b2WheelJointDef.__proto__||Object.getPrototypeOf(b2WheelJointDef)).call(this,exports.b2JointType.e_wheelJoint));_this29.localAnchorA=new b2Vec2(0,0);_this29.localAnchorB=new b2Vec2(0,0);_this29.localAxisA=new b2Vec2(1,0);_this29.enableMotor=false;_this29.maxMotorTorque=0;_this29.motorSpeed=0;_this29.frequencyHz=2;_this29.dampingRatio=0.7;return _this29;}_createClass(b2WheelJointDef,[{key:'Initialize',value:function Initialize(bA,bB,anchor,axis){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.bodyA.GetLocalVector(axis,this.localAxisA);}}]);return b2WheelJointDef;}(b2JointDef);var b2WheelJoint=function(_b2Joint12){_inherits(b2WheelJoint,_b2Joint12);function b2WheelJoint(def){_classCallCheck(this,b2WheelJoint);var _this30=_possibleConstructorReturn(this,(b2WheelJoint.__proto__||Object.getPrototypeOf(b2WheelJoint)).call(this,def));_this30.m_frequencyHz=0;_this30.m_dampingRatio=0;// Solver shared
_this30.m_localAnchorA=new b2Vec2();_this30.m_localAnchorB=new b2Vec2();_this30.m_localXAxisA=new b2Vec2();_this30.m_localYAxisA=new b2Vec2();_this30.m_impulse=0;_this30.m_motorImpulse=0;_this30.m_springImpulse=0;_this30.m_maxMotorTorque=0;_this30.m_motorSpeed=0;_this30.m_enableMotor=false;// Solver temp
_this30.m_indexA=0;_this30.m_indexB=0;_this30.m_localCenterA=new b2Vec2();_this30.m_localCenterB=new b2Vec2();_this30.m_invMassA=0;_this30.m_invMassB=0;_this30.m_invIA=0;_this30.m_invIB=0;_this30.m_ax=new b2Vec2();_this30.m_ay=new b2Vec2();_this30.m_sAx=0;_this30.m_sBx=0;_this30.m_sAy=0;_this30.m_sBy=0;_this30.m_mass=0;_this30.m_motorMass=0;_this30.m_springMass=0;_this30.m_bias=0;_this30.m_gamma=0;_this30.m_qA=new b2Rot();_this30.m_qB=new b2Rot();_this30.m_lalcA=new b2Vec2();_this30.m_lalcB=new b2Vec2();_this30.m_rA=new b2Vec2();_this30.m_rB=new b2Vec2();_this30.m_frequencyHz=b2Maybe(def.frequencyHz,2);_this30.m_dampingRatio=b2Maybe(def.dampingRatio,0.7);_this30.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,b2Vec2.ZERO));_this30.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,b2Vec2.ZERO));_this30.m_localXAxisA.Copy(b2Maybe(def.localAxisA,b2Vec2.UNITX));b2Vec2.CrossOneV(_this30.m_localXAxisA,_this30.m_localYAxisA);_this30.m_maxMotorTorque=b2Maybe(def.maxMotorTorque,0);_this30.m_motorSpeed=b2Maybe(def.motorSpeed,0);_this30.m_enableMotor=b2Maybe(def.enableMotor,false);_this30.m_ax.SetZero();_this30.m_ay.SetZero();return _this30;}_createClass(b2WheelJoint,[{key:'GetMotorSpeed',value:function GetMotorSpeed(){return this.m_motorSpeed;}},{key:'GetMaxMotorTorque',value:function GetMaxMotorTorque(){return this.m_maxMotorTorque;}},{key:'SetSpringFrequencyHz',value:function SetSpringFrequencyHz(hz){this.m_frequencyHz=hz;}},{key:'GetSpringFrequencyHz',value:function GetSpringFrequencyHz(){return this.m_frequencyHz;}},{key:'SetSpringDampingRatio',value:function SetSpringDampingRatio(ratio){this.m_dampingRatio=ratio;}},{key:'GetSpringDampingRatio',value:function GetSpringDampingRatio(){return this.m_dampingRatio;}},{key:'InitVelocityConstraints',value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var mA=this.m_invMassA,mB=this.m_invMassB;var iA=this.m_invIA,iB=this.m_invIB;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// Compute the effective masses.
// b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);var rA=b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
...
var C=b2Vec2.DotVV(d,this.m_ay);var k=this.m_invMassA+this.m_invMassB+this.m_invIA*this.m_sAy*this.m_sAy+this.m_invIB*this.m_sBy*this.m_sBy;var impulse=void 0;if(k!==0){impulse=-C/k;}else{impulse=0;}// b2Vec2 P = impulse * ay;
...
function b2MixRestitution(restitution1,restitution2){return restitution1>restitution2?restitution1:restitution2;}var b2ContactEdge=function b2ContactEdge(contact){_classCallCheck(this,b2ContactEdge);this.prev=null;///< the previous contact edge in the body's contact list
this.next=null;///< the next contact edge in the body's contact list
this.contact=contact;};var b2Contact=function(){function b2Contact(){_classCallCheck(this,b2Contact);this.m_islandFlag=false;/// Used when crawling contact graph when forming islands.
...
this.m_prev=null;this.m_next=null;this.m_indexA=0;this.m_indexB=0;this.m_manifold=new b2Manifold();// TODO: readonly
...
if(sensor){///if (aabbOverlap)
///{
var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();touching=b2TestOverlapShape(shapeA,this.m_indexA,shapeB,this.m_indexB,xfA,xfB);///}
// Sensors don't generate manifolds.
this.m_manifold.pointCount=0;}else{///if (aabbOverlap)
///{
this.Evaluate(this.m_manifold,xfA,xfB);touching=this.m_manifold.pointCount>0;// Match old contact ids to new contact ids and copy the
...
if(touching!==wasTouching){bodyA.SetAwake(true);bodyB.SetAwake(true);}}this.m_touchingFlag=touching;if(!wasTouching&&touching&&listener){listener.BeginContact(this);}if(wasTouching&&!touching&&listener){listener.EndContact(this);}if(!sensor&&touching&&listener){listener.PreSolve(this,this.m_oldManifold);}}},{key:'ComputeTOI',value:function ComputeTOI(sweepA,sweepB){var input=b2Contact.ComputeTOI_s_input;input.proxyA.SetShape(this.m_fixtureA.GetShape(),this.m_indexA);input.proxyB.SetShape(this.m_fixtureB.GetShape(),this.m_indexB);input.sweepA.Copy(sweepA);input.sweepB.Copy(sweepB);input.tMax=b2_linearSlop;var output=b2Contact.ComputeTOI_s_output;b2TimeOfImpact(output,input);return output.t;}}]);return b2Contact;}();b2Contact.ComputeTOI_s_input=new b2TOIInput();b2Contact.ComputeTOI_s_output=new b2TOIOutput();/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2CircleContact=function(_b2Contact){_inherits(b2CircleContact,_b2Contact);function b2CircleContact(){_classCallCheck(this,b2CircleContact);return _possibleConstructorReturn(this,(b2CircleContact.__proto__||Object.getPrototypeOf(b2CircleContact)).call(this));}_createClass(b2CircleContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2CircleContact.prototype.__proto__||Object.getPrototypeOf(b2CircleContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA.GetType() === b2ShapeType.e_circleShape);
// DEBUG: b2Assert(shapeB.GetType() === b2ShapeType.e_circleShape);
b2CollideCircles(manifold,shapeA,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2CircleContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2CircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2PolygonContact=function(_b2Contact2){_inherits(b2PolygonContact,_b2Contact2);function b2PolygonContact(){_classCallCheck(this,b2PolygonContact);return _possibleConstructorReturn(this,(b2PolygonContact.__proto__||Object.getPrototypeOf(b2PolygonContact)).call(this));}_createClass(b2PolygonContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2PolygonContact.prototype.__proto__||Object.getPrototypeOf(b2PolygonContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA.GetType() === b2ShapeType.e_polygonShape);
// DEBUG: b2Assert(shapeB.GetType() === b2ShapeType.e_polygonShape);
b2CollidePolygons(manifold,shapeA,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2PolygonContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2PolygonContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2PolygonAndCircleContact=function(_b2Contact3){_inherits(b2PolygonAndCircleContact,_b2Contact3);function b2PolygonAndCircleContact(){_classCallCheck(this,b2PolygonAndCircleContact);return _possibleConstructorReturn(this,(b2PolygonAndCircleContact.__proto__||Object.getPrototypeOf(b2PolygonAndCircleContact)).call(this));}_createClass(b2PolygonAndCircleContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2PolygonAndCircleContact.prototype.__proto__||Object.getPrototypeOf(b2PolygonAndCircleContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);// DEBUG: b2Assert(fixtureA.GetType() === b2ShapeType.e_polygonShape);
// DEBUG: b2Assert(fixtureB.GetType() === b2ShapeType.e_circleShape);
}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA instanceof b2PolygonShape);
// DEBUG: b2Assert(shapeB instanceof b2CircleShape);
b2CollidePolygonAndCircle(manifold,shapeA,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2PolygonAndCircleContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2PolygonAndCircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2EdgeAndCircleContact=function(_b2Contact4){_inherits(b2EdgeAndCircleContact,_b2Contact4);function b2EdgeAndCircleContact(){_classCallCheck(this,b2EdgeAndCircleContact);return _possibleConstructorReturn(this,(b2EdgeAndCircleContact.__proto__||Object.getPrototypeOf(b2EdgeAndCircleContact)).call(this));}_createClass(b2EdgeAndCircleContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2EdgeAndCircleContact.prototype.__proto__||Object.getPrototypeOf(b2EdgeAndCircleContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);// DEBUG: b2Assert(fixtureA.GetType() === b2ShapeType.e_edgeShape);
// DEBUG: b2Assert(fixtureB.GetType() === b2ShapeType.e_circleShape);
}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA instanceof b2EdgeShape);
// DEBUG: b2Assert(shapeB instanceof b2CircleShape);
b2CollideEdgeAndCircle(manifold,shapeA,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2EdgeAndCircleContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2EdgeAndCircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2EdgeAndPolygonContact=function(_b2Contact5){_inherits(b2EdgeAndPolygonContact,_b2Contact5);function b2EdgeAndPolygonContact(){_classCallCheck(this,b2EdgeAndPolygonContact);return _possibleConstructorReturn(this,(b2EdgeAndPolygonContact.__proto__||Object.getPrototypeOf(b2EdgeAndPolygonContact)).call(this));}_createClass(b2EdgeAndPolygonContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2EdgeAndPolygonContact.prototype.__proto__||Object.getPrototypeOf(b2EdgeAndPolygonContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);// DEBUG: b2Assert(fixtureA.GetType() === b2ShapeType.e_edgeShape);
// DEBUG: b2Assert(fixtureB.GetType() === b2ShapeType.e_polygonShape);
}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA instanceof b2EdgeShape);
// DEBUG: b2Assert(shapeB instanceof b2PolygonShape);
b2CollideEdgeAndPolygon(manifold,shapeA,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2EdgeAndPolygonContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2EdgeAndPolygonContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2ChainAndCircleContact=function(_b2Contact6){_inherits(b2ChainAndCircleContact,_b2Contact6);function b2ChainAndCircleContact(){_classCallCheck(this,b2ChainAndCircleContact);return _possibleConstructorReturn(this,(b2ChainAndCircleContact.__proto__||Object.getPrototypeOf(b2ChainAndCircleContact)).call(this));}_createClass(b2ChainAndCircleContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2ChainAndCircleContact.prototype.__proto__||Object.getPrototypeOf(b2ChainAndCircleContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);// DEBUG: b2Assert(fixtureA.GetType() === b2ShapeType.e_chainShape);
// DEBUG: b2Assert(fixtureB.GetType() === b2ShapeType.e_circleShape);
}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA instanceof b2ChainShape);
// DEBUG: b2Assert(shapeB instanceof b2CircleShape);
var chain=shapeA;var edge=b2ChainAndCircleContact.Evaluate_s_edge;chain.GetChildEdge(edge,this.m_indexA);b2CollideEdgeAndCircle(manifold,edge,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2ChainAndCircleContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2ChainAndCircleContact;}(b2Contact);b2ChainAndCircleContact.Evaluate_s_edge=new b2EdgeShape();/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2ChainAndPolygonContact=function(_b2Contact7){_inherits(b2ChainAndPolygonContact,_b2Contact7);function b2ChainAndPolygonContact(){_classCallCheck(this,b2ChainAndPolygonContact);return _possibleConstructorReturn(this,(b2ChainAndPolygonContact.__proto__||Object.getPrototypeOf(b2ChainAndPolygonContact)).call(this));}_createClass(b2ChainAndPolygonContact,[{key:'Reset',value:function Reset(fixtureA,indexA,fixtureB,indexB){_get(b2ChainAndPolygonContact.prototype.__proto__||Object.getPrototypeOf(b2ChainAndPolygonContact.prototype),'Reset',this).call(this,fixtureA,indexA,fixtureB,indexB);// DEBUG: b2Assert(fixtureA.GetType() === b2ShapeType.e_chainShape);
// DEBUG: b2Assert(fixtureB.GetType() === b2ShapeType.e_polygonShape);
}},{key:'Evaluate',value:function Evaluate(manifold,xfA,xfB){var shapeA=this.m_fixtureA.GetShape();var shapeB=this.m_fixtureB.GetShape();// DEBUG: b2Assert(shapeA instanceof b2ChainShape);
// DEBUG: b2Assert(shapeB instanceof b2PolygonShape);
var chain=shapeA;var edge=b2ChainAndPolygonContact.Evaluate_s_edge;chain.GetChildEdge(edge,this.m_indexA);b2CollideEdgeAndPolygon(manifold,edge,xfA,shapeB,xfB);}}],[{key:'Create',value:function Create(allocator){return new b2ChainAndPolygonContact();}},{key:'Destroy',value:function Destroy(contact,allocator){}}]);return b2ChainAndPolygonContact;}(b2Contact);b2ChainAndPolygonContact.Evaluate_s_edge=new b2EdgeShape();// DEBUG: import { b2Assert } from "../../Common/b2Settings";
var b2ContactRegister=function b2ContactRegister(){_classCallCheck(this,b2ContactRegister);// public pool: b2Contact[];
this.createFcn=null;this.destroyFcn=null;this.primary=false;};var b2ContactFactory=function(){function b2ContactFactory(allocator){_classCallCheck(this,b2ContactFactory);this.m_allocator=null;this.m_allocator=allocator;this.InitializeRegisters();}_createClass(b2ContactFactory,[{key:'AddType',value:function AddType(createFcn,destroyFcn,type1,type2){var _this38=this;var pool=b2MakeArray(256,function(i){return createFcn(_this38.m_allocator);});// TODO: b2Settings
function poolCreateFcn(allocator){// if (pool.length > 0) {
//   return pool.pop();
// }
// return createFcn(allocator);
return pool.pop()||createFcn(allocator);}function poolDestroyFcn(contact,allocator){pool.push(contact);}// this.m_registers[type1][type2].pool = pool;
this.m_registers[type1][type2].createFcn=poolCreateFcn;this.m_registers[type1][type2].destroyFcn=poolDestroyFcn;this.m_registers[type1][type2].primary=true;if(type1!==type2){// this.m_registers[type2][type1].pool = pool;
this.m_registers[type2][type1].createFcn=poolCreateFcn;this.m_registers[type2][type1].destroyFcn=poolDestroyFcn;this.m_registers[type2][type1].primary=false;}/*
...
var b2DestructionListener=function(){function b2DestructionListener(){_classCallCheck(this,b2DestructionListener);}_createClass(b2DestructionListener,[{key:'SayGoodbyeJoint',/// Called when any joint is about to be destroyed due
...
var b2ContactFilter=function(){function b2ContactFilter(){_classCallCheck(this,b2ContactFilter);}_createClass(b2ContactFilter,[{key:'ShouldCollide',/// Return true if contact calculations should be performed between these two shapes.
...
var b2ContactListener=function(){function b2ContactListener(){_classCallCheck(this,b2ContactListener);}_createClass(b2ContactListener,[{key:'BeginContact',/// Called when two fixtures begin to touch.
...
/// See b2World::Query
var b2QueryCallback=function(){function b2QueryCallback(){_classCallCheck(this,b2QueryCallback);}_createClass(b2QueryCallback,[{key:'ReportFixture',/// Called for each fixture found in the query AABB.
...
/// See b2World::RayCast
var b2RayCastCallback=function(){function b2RayCastCallback(){_classCallCheck(this,b2RayCastCallback);}_createClass(b2RayCastCallback,[{key:'ReportFixture',/// Called for each fixture found in the query. You control how the ray cast
...
value:function ReportFixture(fixture,point,normal,fraction){return fraction;}// #if B2_ENABLE_PARTICLE
  ...
  * 3. This notice may not be removed or altered from any source distribution.
  */// Delegate of b2World.
var b2ContactManager=function(){function b2ContactManager(){_classCallCheck(this,b2ContactManager);this.m_broadPhase=new b2BroadPhase();this.m_contactList=null;this.m_contactCount=0;this.m_contactFilter=b2ContactFilter.b2_defaultFilter;this.m_contactListener=b2ContactListener.b2_defaultListener;this.m_allocator=null;this.m_contactFactory=new b2ContactFactory(this.m_allocator);}// Broad-phase callback.
...
// Connect to body A
c.m_nodeA.contact=c;c.m_nodeA.other=bodyB;c.m_nodeA.prev=null;c.m_nodeA.next=bodyA.m_contactList;if(bodyA.m_contactList!==null){bodyA.m_contactList.prev=c.m_nodeA;}bodyA.m_contactList=c.m_nodeA;// Connect to body B
c.m_nodeB.contact=c;c.m_nodeB.other=bodyA;c.m_nodeB.prev=null;c.m_nodeB.next=bodyB.m_contactList;if(bodyB.m_contactList!==null){bodyB.m_contactList.prev=c.m_nodeB;}bodyB.m_contactList=c.m_nodeB;// Wake up the bodies
if(!fixtureA.IsSensor()&&!fixtureB.IsSensor()){bodyA.SetAwake(true);bodyB.SetAwake(true);}++this.m_contactCount;}},{key:'FindNewContacts',value:function FindNewContacts(){var _this39=this;this.m_broadPhase.UpdatePairs(function(proxyA,proxyB){_this39.AddPair(proxyA,proxyB);});}},{key:'Destroy',value:function Destroy(c){var fixtureA=c.GetFixtureA();var fixtureB=c.GetFixtureB();var bodyA=fixtureA.GetBody();var bodyB=fixtureB.GetBody();if(this.m_contactListener&&c.IsTouching()){this.m_contactListener.EndContact(c);}// Remove from the world.
...
if(c.m_nodeB.prev){c.m_nodeB.prev.next=c.m_nodeB.next;}if(c.m_nodeB.next){c.m_nodeB.next.prev=c.m_nodeB.prev;}if(c.m_nodeB===bodyB.m_contactList){bodyB.m_contactList=c.m_nodeB.next;}// Call the factory.
...
if(!activeA&&!activeB){c=c.m_next;continue;}var proxyA=fixtureA.m_proxies[indexA].treeNode;var proxyB=fixtureB.m_proxies[indexB].treeNode;var overlap=b2TestOverlapAABB(proxyA.aabb,proxyB.aabb);// Here we destroy contacts that cease to overlap in the broad-phase.
...
var b2Profile=function(){function b2Profile(){_classCallCheck(this,b2Profile);this.step=0;this.collide=0;this.solve=0;this.solveInit=0;this.solveVelocity=0;this.solvePosition=0;this.broadphase=0;this.solveTOI=0;}_createClass(b2Profile,[{key:'Reset',value:function Reset(){this.step=0;this.collide=0;this.solve=0;this.solveInit=0;this.solveVelocity=0;this.solvePosition=0;this.broadphase=0;this.solveTOI=0;return this;}}]);return b2Profile;}();/// This is an internal structure.
var b2TimeStep=function(){function b2TimeStep(){_classCallCheck(this,b2TimeStep);this.dt=0;// time step
...
this.warmStarting=step.warmStarting;return this;}}]);return b2TimeStep;}();var b2Position=function(){function b2Position(){_classCallCheck(this,b2Position);this.c=new b2Vec2();this.a=0;}_createClass(b2Position,null,[{key:'MakeArray',value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Position();});}}]);return b2Position;}();var b2Velocity=function(){function b2Velocity(){_classCallCheck(this,b2Velocity);this.v=new b2Vec2();this.w=0;}_createClass(b2Velocity,null,[{key:'MakeArray',value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Velocity();});}}]);return b2Velocity;}();var b2SolverData=function b2SolverData(){_classCallCheck(this,b2SolverData);this.step=new b2TimeStep();};/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
...
// normal = -normal;
this.normal.SelfNeg();break;}}}}]);return b2PositionSolverManifold;}();b2PositionSolverManifold.Initialize_s_pointA=new b2Vec2();b2PositionSolverManifold.Initialize_s_pointB=new b2Vec2();b2PositionSolverManifold.Initialize_s_planePoint=new b2Vec2();b2PositionSolverManifold.Initialize_s_clipPoint=new b2Vec2();var b2ContactSolver=function(){function b2ContactSolver(){_classCallCheck(this,b2ContactSolver);this.m_step=new b2TimeStep();this.m_allocator=null;this.m_positionConstraints=b2ContactPositionConstraint.MakeArray(1024);// TODO: b2Settings
this.m_velocityConstraints=b2ContactVelocityConstraint.MakeArray(1024);// TODO: b2Settings
this.m_count=0;}_createClass(b2ContactSolver,[{key:'Initialize',value:function Initialize(def){this.m_step.Copy(def.step);this.m_allocator=def.allocator;this.m_count=def.count;// TODO:
...
return minSeparation>=-1.5*b2_linearSlop;}}]);return b2ContactSolver;}();b2ContactSolver.InitializeVelocityConstraints_s_xfA=new b2Transform();b2ContactSolver.InitializeVelocityConstraints_s_xfB=new b2Transform();b2ContactSolver.InitializeVelocityConstraints_s_worldManifold=new b2WorldManifold();b2ContactSolver.WarmStart_s_P=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv1=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv2=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_a=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_b=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_x=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_d=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P1=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P2=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P1P2=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_xfA=new b2Transform();b2ContactSolver.SolvePositionConstraints_s_xfB=new b2Transform();b2ContactSolver.SolvePositionConstraints_s_psm=new b2PositionSolverManifold();b2ContactSolver.SolvePositionConstraints_s_rA=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_rB=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_P=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_xfA=new b2Transform();b2ContactSolver.SolveTOIPositionConstraints_s_xfB=new b2Transform();b2ContactSolver.SolveTOIPositionConstraints_s_psm=new b2PositionSolverManifold();b2ContactSolver.SolveTOIPositionConstraints_s_rA=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_rB=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_P=new b2Vec2();/*
  ...
  */var b2Island=function(){function b2Island(){_classCallCheck(this,b2Island);this.m_allocator=null;this.m_bodies=[/*1024*/];// TODO: b2Settings
...
var B2_MAX_RECOMMENDED_PARTICLE_ITERATIONS=8;var B2_RADIUS_THRESHOLD=0.01;var iterations=Math.ceil(Math.sqrt(gravity/(B2_RADIUS_THRESHOLD*radius))*timeStep);return b2Clamp(iterations,1,B2_MAX_RECOMMENDED_PARTICLE_ITERATIONS);}var b2ParticleHandle=function(){function b2ParticleHandle(){_classCallCheck(this,b2ParticleHandle);this.m_index=b2_invalidParticleIndex;}_createClass(b2ParticleHandle,[{key:'GetIndex',value:function GetIndex(){return this.m_index;}},{key:'SetIndex',value:function SetIndex(index){this.m_index=index;}}]);return b2ParticleHandle;}();// #endif
/*
   * Copyright (c) 2013 Google, Inc.
   *
   * This software is provided 'as-is', without any express or implied
...
/*
   ...
   * misrepresented as being the original software.
   * 3. This notice may not be removed or altered from any source distribution.
   */var b2StackQueue=function(){function b2StackQueue(capacity){_classCallCheck(this,b2StackQueue);this.m_front=0;this.m_back=0;this.m_capacity=0;this.m_buffer=b2MakeArray(capacity,function(index){return null;});this.m_capacity=capacity;}_createClass(b2StackQueue,[{key:'Push',value:function Push(item){if(this.m_back>=this.m_capacity){for(var i=this.m_front;i<this.m_back;i++){this.m_buffer[i-this.m_front]=this.m_buffer[i];}this.m_back-=this.m_front;this.m_front=0;if(this.m_back>=this.m_capacity){if(this.m_capacity>0){this.m_buffer.concat(b2MakeArray(this.m_capacity,function(index){return null;}));this.m_capacity*=2;}else{this.m_buffer.concat(b2MakeArray(1,function(index){return null;}));this.m_capacity=1;}///m_buffer = (T*) m_allocator->Reallocate(m_buffer, sizeof(T) * m_capacity);
}}this.m_buffer[this.m_back]=item;this.m_back++;}},{key:'Pop',value:function Pop(){// DEBUG: b2Assert(this.m_front < this.m_back);
...
this.m_countX=0;this.m_countY=0;return;}lower.x-=margin;lower.y-=margin;upper.x+=margin;upper.y+=margin;this.m_countX=1+Math.floor(inverseRadius*(upper.x-lower.x));this.m_countY=1+Math.floor(inverseRadius*(upper.y-lower.y));///  m_diagram = (Generator**) m_allocator->Allocate(sizeof(Generator*) * m_countX * m_countY);
...
_g.center.SelfSub(lower).SelfMul(inverseRadius);var x=Math.floor(_g.center.x);var y=Math.floor(_g.center.y);if(x>=0&&y>=0&&x<this.m_countX&&y<this.m_countY){queue.Push(new b2VoronoiDiagram.Task(x,y,x+y*this.m_countX,_g));}}while(!queue.Empty()){var task=queue.Front();var _x38=task.m_x;var _y=task.m_y;var i=task.m_i;var _g2=task.m_generator;queue.Pop();if(!this.m_diagram[i]){this.m_diagram[i]=_g2;if(_x38>0){queue.Push(new b2VoronoiDiagram.Task(_x38-1,_y,i-1,_g2));}if(_y>0){queue.Push(new b2VoronoiDiagram.Task(_x38,_y-1,i-this.m_countX,_g2));}if(_x38<this.m_countX-1){queue.Push(new b2VoronoiDiagram.Task(_x38+1,_y,i+1,_g2));}if(_y<this.m_countY-1){queue.Push(new b2VoronoiDiagram.Task(_x38,_y+1,i+this.m_countX,_g2));}}}for(var _y2=0;_y2<this.m_countY;_y2++){for(var _x39=0;_x39<this.m_countX-1;_x39++){var _i26=_x39+_y2*this.m_countX;var a=this.m_diagram[_i26];var b=this.m_diagram[_i26+1];if(a!==b){queue.Push(new b2VoronoiDiagram.Task(_x39,_y2,_i26,b));queue.Push(new b2VoronoiDiagram.Task(_x39+1,_y2,_i26+1,a));}}}for(var _y3=0;_y3<this.m_countY-1;_y3++){for(var _x40=0;_x40<this.m_countX;_x40++){var _i27=_x40+_y3*this.m_countX;var _a2=this.m_diagram[_i27];var _b3=this.m_diagram[_i27+this.m_countX];if(_a2!==_b3){queue.Push(new b2VoronoiDiagram.Task(_x40,_y3,_i27,_b3));queue.Push(new b2VoronoiDiagram.Task(_x40,_y3+1,_i27+this.m_countX,_a2));}}}while(!queue.Empty()){var _task=queue.Front();var _x41=_task.m_x;var _y4=_task.m_y;var _i28=_task.m_i;var _k5=_task.m_generator;queue.Pop();var _a3=this.m_diagram[_i28];var _b4=_k5;if(_a3!==_b4){var ax=_a3.center.x-_x41;var ay=_a3.center.y-_y4;var bx=_b4.center.x-_x41;var by=_b4.center.y-_y4;var a2=ax*ax+ay*ay;var b2=bx*bx+by*by;if(a2>b2){this.m_diagram[_i28]=_b4;if(_x41>0){queue.Push(new b2VoronoiDiagram.Task(_x41-1,_y4,_i28-1,_b4));}if(_y4>0){queue.Push(new b2VoronoiDiagram.Task(_x41,_y4-1,_i28-this.m_countX,_b4));}if(_x41<this.m_countX-1){queue.Push(new b2VoronoiDiagram.Task(_x41+1,_y4,_i28+1,_b4));}if(_y4<this.m_countY-1){queue.Push(new b2VoronoiDiagram.Task(_x41,_y4+1,_i28+this.m_countX,_b4));}}}}}/**
       * Enumerate all nodes that contain at least one necessary
       * generator.
       */},{key:'GetNodes',value:function GetNodes(callback){for(var y=0;y<this.m_countY-1;y++){for(var x=0;x<this.m_countX-1;x++){var i=x+y*this.m_countX;var a=this.m_diagram[i];var b=this.m_diagram[i+1];var c=this.m_diagram[i+this.m_countX];var d=this.m_diagram[i+1+this.m_countX];if(b!==c){if(a!==b&&a!==c&&(a.necessary||b.necessary||c.necessary)){callback(a.tag,b.tag,c.tag);}if(d!==b&&d!==c&&(a.necessary||b.necessary||c.necessary)){callback(b.tag,d.tag,c.tag);}}}}}}]);return b2VoronoiDiagram;}();(function(b2VoronoiDiagram){var Generator=function Generator(){_classCallCheck(this,Generator);this.center=new b2Vec2();this.tag=0;this.necessary=false;};b2VoronoiDiagram.Generator=Generator;var Task=function Task(x,y,i,g){_classCallCheck(this,Task);this.m_x=x;this.m_y=y;this.m_i=i;this.m_generator=g;};b2VoronoiDiagram.Task=Task;})(b2VoronoiDiagram||(b2VoronoiDiagram={}));// namespace b2VoronoiDiagram
// #endif
/*
   * Copyright (c) 2013 Google, Inc.
   *
...
std_iter_swap(array,l++,c);}return l;}function std_lower_bound(array,first,last,val,cmp){var count=last-first;while(count>0){var step=Math.floor(count/2);var it=first+step;if(cmp(array[it],val)){first=++it;count-=step+1;}else{count=step;}}return first;}function std_upper_bound(array,first,last,val,cmp){var count=last-first;while(count>0){var step=Math.floor(count/2);var it=first+step;if(!cmp(val,array[it])){first=++it;count-=step+1;}else{count=step;}}return first;}function std_rotate(array,first,n_first,last){var next=n_first;while(first!==next){std_iter_swap(array,first++,next++);if(next===last){next=n_first;}else if(first===n_first){n_first=next;}}}function std_unique(array,first,last,cmp){if(first===last){return last;}var result=first;while(++first!==last){if(!cmp(array[result],array[first])){///array[++result] = array[first];
std_iter_swap(array,++result,first);}}return++result;}var b2GrowableBuffer=function(){function b2GrowableBuffer(allocator){_classCallCheck(this,b2GrowableBuffer);this.data=[];this.count=0;this.capacity=0;this.allocator=allocator;}_createClass(b2GrowableBuffer,[{key:'Append',value:function Append(){if(this.count>=this.capacity){this.Grow();}return this.count++;}},{key:'Reserve',value:function Reserve(newCapacity){if(this.capacity>=newCapacity){return;}// DEBUG: b2Assert(this.capacity === this.data.length);
...
}},{key:'Unique',value:function Unique(pred){this.count=std_unique(this.data,0,this.count,pred);}}]);return b2GrowableBuffer;}();var b2FixtureParticleQueryCallback=function(_b2QueryCallback){_inherits(b2FixtureParticleQueryCallback,_b2QueryCallback);function b2FixtureParticleQueryCallback(system){_classCallCheck(this,b2FixtureParticleQueryCallback);var _this40=_possibleConstructorReturn(this,(b2FixtureParticleQueryCallback.__proto__||Object.getPrototypeOf(b2FixtureParticleQueryCallback)).call(this));_this40.m_system=system;return _this40;}_createClass(b2FixtureParticleQueryCallback,[{key:'ShouldQueryParticleSystem',value:function ShouldQueryParticleSystem(system){// Skip reporting particles.
...
this.pb=new b2Vec2(0.0,0.0);this.pc=new b2Vec2(0.0,0.0);this.ka=0.0;this.kb=0.0;this.kc=0.0;this.s=0.0;};var b2ParticleSystemDef=function(){function b2ParticleSystemDef(){_classCallCheck(this,b2ParticleSystemDef);// Initialize physical coefficients to the maximum values that
...
/**
           ...
           * reallocated on subsequent CreateParticle() calls.
           */this.m_depthBuffer=[];this.m_colorBuffer=new b2ParticleSystem.UserOverridableBuffer();this.m_groupBuffer=[];this.m_userDataBuffer=new b2ParticleSystem.UserOverridableBuffer();/**
           ...
           */this.m_expirationTimeBufferRequiresSorting=false;this.m_groupCount=0;this.m_groupList=null;this.m_def=new b2ParticleSystemDef();this.m_prev=null;this.m_next=null;this.SetStrictContactCheck(def.strictContactCheck);this.SetDensity(def.density);this.SetGravityScale(def.gravityScale);this.SetRadius(def.radius);this.SetMaxParticleCount(def.maxCount);// DEBUG: b2Assert(def.lifetimeGranularity > 0.0);
...
// queue.
if(!this.m_indexByExpirationTimeBuffer.data){throw new Error();}this.m_indexByExpirationTimeBuffer.data[index]=index;}proxy.index=index;var group=b2Maybe(def.group,null);this.m_groupBuffer[index]=group;if(group){if(group.m_firstIndex<group.m_lastIndex){// Move particles in the group just before the new particle.
...
handle.SetIndex(index);this.m_handleIndexBuffer.data[index]=handle;return handle;}/**
       ...
       *      destroyed.
       */},{key:'DestroyParticle',value:function DestroyParticle(index){var callDestructionListener=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;if(!this.m_flagsBuffer.data){throw new Error();}var flags=exports.b2ParticleFlag.b2_zombieParticle;if(callDestructionListener){flags|=exports.b2ParticleFlag.b2_destructionListenerParticle;}this.SetParticleFlags(index,this.m_flagsBuffer.data[index]|flags);}/**
...
if(!this.m_indexByExpirationTimeBuffer.data){throw new Error();}if(!this.m_expirationTimeBuffer.data){throw new Error();}// Destroy the oldest particle (preferring to destroy finite
...
var oldestFiniteLifetimeParticle=this.m_indexByExpirationTimeBuffer.data[particleCount-(index+1)];var oldestInfiniteLifetimeParticle=this.m_indexByExpirationTimeBuffer.data[index];this.DestroyParticle(this.m_expirationTimeBuffer.data[oldestFiniteLifetimeParticle]>0.0?oldestFiniteLifetimeParticle:oldestInfiniteLifetimeParticle,callDestructionListener);}/**
       ...
       *      destroyed.
       */},{key:'DestroyParticlesInShape',value:function DestroyParticlesInShape(shape,xf){var callDestructionListener=arguments.length>2&&arguments[2]!==undefined?arguments[2]:false;var s_aabb=b2ParticleSystem.DestroyParticlesInShape_s_aabb;if(this.m_world.IsLocked()){throw new Error();}var callback=new b2ParticleSystem.DestroyParticlesInShapeCallback(this,shape,xf,callDestructionListener);var aabb=s_aabb;shape.ComputeAABB(aabb,xf,0);this.m_world.QueryAABB(callback,aabb);return callback.Destroyed();}/**
...
var filter=new b2ParticleSystem.ConnectionFilter();this.UpdateContacts(true);this.UpdatePairsAndTriads(firstIndex,lastIndex,filter);if(groupDef.group){this.JoinParticleGroups(groupDef.group,group);group=groupDef.group;}return group;}/**
...
var filter=new b2ParticleSystem.JoinParticleGroupsFilter(groupB.m_firstIndex);this.UpdateContacts(true);this.UpdatePairsAndTriads(groupA.m_firstIndex,groupB.m_lastIndex,filter);for(var i=groupB.m_firstIndex;i<groupB.m_lastIndex;i++){this.m_groupBuffer[i]=groupA;}var groupFlags=groupA.m_groupFlags|groupB.m_groupFlags;this.SetGroupFlags(groupA,groupFlags);groupA.m_lastIndex=groupB.m_lastIndex;groupB.m_firstIndex=groupB.m_lastIndex;this.DestroyParticleGroup(groupB);}/**
...
this.m_def.maxCount=count;}/**
       ...
       */},{key:'GetPositionBuffer',value:function GetPositionBuffer(){if(!this.m_positionBuffer.data){throw new Error();}return this.m_positionBuffer.data;}/**
       * Get the velocity of each particle
       *
       * Array is length GetParticleCount()
       *
       * @return the pointer to the head of the particle velocities array.
       */},{key:'GetVelocityBuffer',value:function GetVelocityBuffer(){if(!this.m_velocityBuffer.data){throw new Error();}return this.m_velocityBuffer.data;}/**
       ...
       */},{key:'GetFlagsBuffer',value:function GetFlagsBuffer(){if(!this.m_flagsBuffer.data){throw new Error();}return this.m_flagsBuffer.data;}/**
       * Set flags for a particle. See the b2ParticleFlag enum.
       */},{key:'SetParticleFlags',value:function SetParticleFlags(index,newFlags){if(!this.m_flagsBuffer.data){throw new Error();}var oldFlags=this.m_flagsBuffer.data[index];if(oldFlags&~newFlags){// If any flags might be removed
...
if(newFlags&exports.b2ParticleFlag.b2_tensileParticle){this.m_accumulation2Buffer=this.RequestBuffer(this.m_accumulation2Buffer);}if(newFlags&exports.b2ParticleFlag.b2_colorMixingParticle){this.m_colorBuffer.data=this.RequestBuffer(this.m_colorBuffer.data);}this.m_allParticleFlags|=newFlags;}this.m_flagsBuffer.data[index]=newFlags;}/**
       ...
       */},{key:'GetParticleFlags',value:function GetParticleFlags(index){if(!this.m_flagsBuffer.data){throw new Error();}return this.m_flagsBuffer.data[index];}/**
       ...
       */},{key:'SetFlagsBuffer',value:function SetFlagsBuffer(buffer,capacity){this.SetUserOverridableBuffer(this.m_flagsBuffer,buffer,capacity);}},{key:'SetPositionBuffer',value:function SetPositionBuffer(buffer,capacity){///if (buffer instanceof Float32Array) {
///let array = [];
...
}},{key:'SetVelocityBuffer',value:function SetVelocityBuffer(buffer,capacity){///if (buffer instanceof Float32Array) {
///let array = [];
///for (let i = 0; i < capacity; ++i) {
///  array[i] = new b2Vec2(buffer.subarray(i * 2, i * 2 + 2));
///}
...
}},{key:'SetColorBuffer',value:function SetColorBuffer(buffer,capacity){///if (buffer instanceof Uint8Array) {
///let array: b2Color[] = [];
///for (let i = 0; i < capacity; ++i) {
...
}},{key:'SetUserDataBuffer',value:function SetUserDataBuffer(buffer,capacity){this.SetUserOverridableBuffer(this.m_userDataBuffer,buffer,capacity);}/**
...
return this.m_stuckParticleBuffer.GetCount();}/**
       ...
       */},{key:'ComputeCollisionEnergy',value:function ComputeCollisionEnergy(){if(!this.m_velocityBuffer.data){throw new Error();}var s_v=b2ParticleSystem.ComputeCollisionEnergy_s_v;var vel_data=this.m_velocityBuffer.data;var sum_v2=0;for(var k=0;k<this.m_contactBuffer.count;k++){var contact=this.m_contactBuffer.data[k];var a=contact.indexA;var b=contact.indexB;var n=contact.normal;///b2Vec2 v = m_velocityBuffer.data[b] - m_velocityBuffer.data[a];
...
if(this.GetParticleCount()){this.SetParticleLifetime(0,this.GetParticleLifetime(0));}else{this.m_indexByExpirationTimeBuffer.data=this.RequestBuffer(this.m_indexByExpirationTimeBuffer.data);}if(!this.m_indexByExpirationTimeBuffer.data){throw new Error();}return this.m_indexByExpirationTimeBuffer.data;}/**
       ...
       * @param impulse the world impulse vector, usually in N-seconds or kg-m/s.
       */},{key:'ApplyLinearImpulse',value:function ApplyLinearImpulse(firstIndex,lastIndex,impulse){if(!this.m_velocityBuffer.data){throw new Error();}var vel_data=this.m_velocityBuffer.data;var numParticles=lastIndex-firstIndex;var totalMass=numParticles*this.GetParticleMass();///const b2Vec2 velocityDelta = impulse / totalMass;
...
vel_data[i].SelfAdd(velocityDelta);}}},{key:'ParticleApplyForce',/**
       ...
       * @param index the particle that will be modified.
       * @param force the world force vector, usually in Newtons (N).
       */value:function ParticleApplyForce(index,force){if(!this.m_flagsBuffer.data){throw new Error();}if(b2ParticleSystem.IsSignificantForce(force)&&this.ForceCanBeApplied(this.m_flagsBuffer.data[index])){this.PrepareForceBuffer();///m_forceBuffer[index] += force;
...
this.m_forceBuffer[i].SelfAdd(distributedForce);}}}/**
       ...
       */},{key:'QueryAABB',value:function QueryAABB(callback,aabb){if(this.m_proxyBuffer.count===0){return;}var beginProxy=0;var endProxy=this.m_proxyBuffer.count;var firstProxy=std_lower_bound(this.m_proxyBuffer.data,beginProxy,endProxy,b2ParticleSystem.computeTag(this.m_inverseDiameter*aabb.lowerBound.x,this.m_inverseDiameter*aabb.lowerBound.y),b2ParticleSystem.Proxy.CompareProxyTag);var lastProxy=std_upper_bound(this.m_proxyBuffer.data,firstProxy,endProxy,b2ParticleSystem.computeTag(this.m_inverseDiameter*aabb.upperBound.x,this.m_inverseDiameter*aabb.upperBound.y),b2ParticleSystem.Proxy.CompareTagProxy);if(!this.m_positionBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;for(var k=firstProxy;k<lastProxy;++k){var proxy=this.m_proxyBuffer.data[k];var i=proxy.index;var p=pos_data[i];if(aabb.lowerBound.x<p.x&&p.x<aabb.upperBound.x&&aabb.lowerBound.y<p.y&&p.y<aabb.upperBound.y){if(!callback.ReportParticle(this,i)){break;}}}}/**
       * Query the particle system for all particles that potentially
       ...
       */},{key:'RayCast',value:function RayCast(callback,point1,point2){var s_aabb=b2ParticleSystem.RayCast_s_aabb;var s_p=b2ParticleSystem.RayCast_s_p;var s_v=b2ParticleSystem.RayCast_s_v;var s_n=b2ParticleSystem.RayCast_s_n;var s_point=b2ParticleSystem.RayCast_s_point;if(this.m_proxyBuffer.count===0){return;}if(!this.m_positionBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var aabb=s_aabb;b2Vec2.MinV(point1,point2,aabb.lowerBound);b2Vec2.MaxV(point1,point2,aabb.upperBound);var fraction=1;// solving the following equation:
// ((1-t)*point1+t*point2-position)^2=diameter^2
// where t is a potential fraction
///b2Vec2 v = point2 - point1;
var v=b2Vec2.SubVV(point2,point1,s_v);var v2=b2Vec2.DotVV(v,v);var enumerator=this.GetInsideBoundsEnumerator(aabb);var i=void 0;while((i=enumerator.GetNext())>=0){///b2Vec2 p = point1 - m_positionBuffer.data[i];
...
aabb.lowerBound.x=+b2_maxFloat;aabb.lowerBound.y=+b2_maxFloat;aabb.upperBound.x=-b2_maxFloat;aabb.upperBound.y=-b2_maxFloat;if(!this.m_positionBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;for(var i=0;i<particleCount;i++){var p=pos_data[i];b2Vec2.MinV(aabb.lowerBound,p,aabb.lowerBound);b2Vec2.MaxV(aabb.upperBound,p,aabb.upperBound);}aabb.lowerBound.x-=this.m_particleDiameter;aabb.lowerBound.y-=this.m_particleDiameter;aabb.upperBound.x+=this.m_particleDiameter;aabb.upperBound.y+=this.m_particleDiameter;}},{key:'FreeBuffer',value:function FreeBuffer(b,capacity){if(b===null){return;}b.length=0;}},{key:'FreeUserOverridableBuffer',value:function FreeUserOverridableBuffer(b){if(b.userSuppliedCapacity===0){this.FreeBuffer(b.data,this.m_internalAllocatedCapacity);}}/**
       * Reallocate a buffer
...
for(var k=0;k<this.m_pairBuffer.count;k++){var pair=this.m_pairBuffer.data[k];var a=pair.indexA;var b=pair.indexB;if(group.ContainsParticle(a)){pair.indexA=nodeBuffer[a-bufferIndex].index;}if(group.ContainsParticle(b)){pair.indexB=nodeBuffer[b-bufferIndex].index;}}for(var _k6=0;_k6<this.m_triadBuffer.count;_k6++){var triad=this.m_triadBuffer.data[_k6];var _a4=triad.indexA;var _b5=triad.indexB;var c=triad.indexC;if(group.ContainsParticle(_a4)){triad.indexA=nodeBuffer[_a4-bufferIndex].index;}if(group.ContainsParticle(_b5)){triad.indexB=nodeBuffer[_b5-bufferIndex].index;}if(group.ContainsParticle(c)){triad.indexC=nodeBuffer[c-bufferIndex].index;}}}},{key:'ComputeDepth',value:function ComputeDepth(){///b2ParticleContact* contactGroups = (b2ParticleContact*) this.m_world.m_stackAllocator.Allocate(sizeof(b2ParticleContact) * this.m_contactBuffer.GetCount());
var contactGroups=[];// TODO: static
var contactGroupsCount=0;for(var k=0;k<this.m_contactBuffer.count;k++){var contact=this.m_contactBuffer.data[k];var a=contact.indexA;var b=contact.indexB;var groupA=this.m_groupBuffer[a];var groupB=this.m_groupBuffer[b];if(groupA&&groupA===groupB&&groupA.m_groupFlags&exports.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth){contactGroups[contactGroupsCount++]=contact;}}///b2ParticleGroup** groupsToUpdate = (b2ParticleGroup**) this.m_world.m_stackAllocator.Allocate(sizeof(b2ParticleGroup*) * this.m_groupCount);
...
return new b2ParticleSystem.InsideBoundsEnumerator(this,lowerTag,upperTag,firstProxy,lastProxy);}},{key:'UpdateAllParticleFlags',value:function UpdateAllParticleFlags(){if(!this.m_flagsBuffer.data){throw new Error();}this.m_allParticleFlags=0;for(var i=0;i<this.m_count;i++){this.m_allParticleFlags|=this.m_flagsBuffer.data[i];}this.m_needsUpdateAllParticleFlags=false;}},{key:'UpdateAllGroupFlags',value:function UpdateAllGroupFlags(){this.m_allGroupFlags=0;for(var group=this.m_groupList;group;group=group.GetNext()){this.m_allGroupFlags|=group.m_groupFlags;}this.m_needsUpdateAllGroupFlags=false;}},{key:'AddContact',value:function AddContact(a,b,contacts){if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}var s_d=b2ParticleSystem.AddContact_s_d;var pos_data=this.m_positionBuffer.data;// DEBUG: b2Assert(contacts === this.m_contactBuffer);
///b2Vec2 d = m_positionBuffer.data[b] - m_positionBuffer.data[a];
var d=b2Vec2.SubVV(pos_data[b],pos_data[a],s_d);var distBtParticlesSq=b2Vec2.DotVV(d,d);if(distBtParticlesSq<this.m_squaredDiameter){var invD=b2InvSqrt(distBtParticlesSq);if(!isFinite(invD)){invD=1.98177537e+019;}///b2ParticleContact& contact = contacts.Append();
var contact=this.m_contactBuffer.data[this.m_contactBuffer.Append()];contact.indexA=a;contact.indexB=b;contact.flags=this.m_flagsBuffer.data[a]|this.m_flagsBuffer.data[b];contact.weight=1-distBtParticlesSq*invD*this.m_inverseDiameter;///contact.SetNormal(invD * d);
b2Vec2.MulSV(invD,d,contact.normal);}}},{key:'FindContacts_Reference',value:function FindContacts_Reference(contacts){// DEBUG: b2Assert(contacts === this.m_contactBuffer);
...
if(!this.m_positionBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var inv_diam=this.m_inverseDiameter;for(var k=0;k<this.m_proxyBuffer.count;++k){var proxy=this.m_proxyBuffer.data[k];var i=proxy.index;var p=pos_data[i];proxy.tag=b2ParticleSystem.computeTag(inv_diam*p.x,inv_diam*p.y);}}///void UpdateProxies_Simd(b2GrowableBuffer<Proxy>& proxies) const;
...
std_sort(this.m_proxyBuffer.data,0,this.m_proxyBuffer.count,b2ParticleSystem.Proxy.CompareProxyProxy);}},{key:'FilterContacts',value:function FilterContacts(contacts){// Optionally filter the contact.
...
}},{key:'UpdateContacts',value:function UpdateContacts(exceptZombie){this.UpdateProxies(this.m_proxyBuffer);this.SortProxies(this.m_proxyBuffer);///b2ParticlePairSet particlePairs(&this.m_world.m_stackAllocator);
...
this.NotifyBodyContactListenerPreContact(fixtureSet);if(this.m_stuckThreshold>0){if(!this.m_bodyContactCountBuffer.data){throw new Error();}if(!this.m_lastBodyContactStepBuffer.data){throw new Error();}if(!this.m_consecutiveContactStepsBuffer.data){throw new Error();}var particleCount=this.GetParticleCount();for(var i=0;i<particleCount;i++){// Detect stuck particles, see comment in
// b2ParticleSystem::DetectStuckParticle()
this.m_bodyContactCountBuffer.data[i]=0;if(this.m_timestamp>this.m_lastBodyContactStepBuffer.data[i]+1){this.m_consecutiveContactStepsBuffer.data[i]=0;}}}this.m_bodyContactBuffer.SetCount(0);this.m_stuckParticleBuffer.SetCount(0);var aabb=s_aabb;this.ComputeAABB(aabb);var callback=new b2ParticleSystem.UpdateBodyContactsCallback(this,this.GetFixtureContactFilter());this.m_world.QueryAABB(callback,aabb);if(this.m_def.strictContactCheck){this.RemoveSpuriousBodyContacts();}this.NotifyBodyContactListenerPostContact(fixtureSet);}},{key:'Solve',value:function Solve(step){var s_subStep=b2ParticleSystem.Solve_s_subStep;if(this.m_count===0){return;}// If particle lifetimes are enabled, destroy particles that are too old.
...
if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}for(var i=0;i<this.m_count;i++){///m_positionBuffer.data[i] += subStep.dt * m_velocityBuffer.data[i];
this.m_positionBuffer.data[i].SelfMulAdd(subStep.dt,this.m_velocityBuffer.data[i]);}}}},{key:'SolveCollision',value:function SolveCollision(step){var s_aabb=b2ParticleSystem.SolveCollision_s_aabb;if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;// This function detects particles which are crossing boundary of bodies
...
aabb.upperBound.x=b2Max(aabb.upperBound.x,b2Max(p1.x,p2_x));aabb.upperBound.y=b2Max(aabb.upperBound.y,b2Max(p1.y,p2_y));}var callback=new b2ParticleSystem.SolveCollisionCallback(this,step);this.m_world.QueryAABB(callback,aabb);}},{key:'LimitVelocity',value:function LimitVelocity(step){if(!this.m_velocityBuffer.data){throw new Error();}var vel_data=this.m_velocityBuffer.data;var criticalVelocitySquared=this.GetCriticalVelocitySquared(step);for(var i=0;i<this.m_count;i++){var v=vel_data[i];var v2=b2Vec2.DotVV(v,v);if(v2>criticalVelocitySquared){///v *= b2Sqrt(criticalVelocitySquared / v2);
v.SelfMul(b2Sqrt(criticalVelocitySquared/v2));}}}},{key:'SolveGravity',value:function SolveGravity(step){if(!this.m_velocityBuffer.data){throw new Error();}var s_gravity=b2ParticleSystem.SolveGravity_s_gravity;var vel_data=this.m_velocityBuffer.data;///b2Vec2 gravity = step.dt * m_def.gravityScale * m_world.GetGravity();
var gravity=b2Vec2.MulSV(step.dt*this.m_def.gravityScale,this.m_world.GetGravity(),s_gravity);for(var i=0;i<this.m_count;i++){vel_data[i].SelfAdd(gravity);}}},{key:'SolveBarrier',value:function SolveBarrier(step){var s_aabb=b2ParticleSystem.SolveBarrier_s_aabb;var s_va=b2ParticleSystem.SolveBarrier_s_va;var s_vb=b2ParticleSystem.SolveBarrier_s_vb;var s_pba=b2ParticleSystem.SolveBarrier_s_pba;var s_vba=b2ParticleSystem.SolveBarrier_s_vba;var s_vc=b2ParticleSystem.SolveBarrier_s_vc;var s_pca=b2ParticleSystem.SolveBarrier_s_pca;var s_vca=b2ParticleSystem.SolveBarrier_s_vca;var s_qba=b2ParticleSystem.SolveBarrier_s_qba;var s_qca=b2ParticleSystem.SolveBarrier_s_qca;var s_dv=b2ParticleSystem.SolveBarrier_s_dv;var s_f=b2ParticleSystem.SolveBarrier_s_f;if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;// If a particle is passing between paired barrier particles,
...
vel_data[_b9].SelfAdd(_f2);}}},{key:'SolveDamping',value:function SolveDamping(step){var s_v=b2ParticleSystem.SolveDamping_s_v;var s_f=b2ParticleSystem.SolveDamping_s_f;if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;// reduces normal velocity of each contact
...
if(!this.m_positionBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var damping=this.m_def.dampingStrength;for(var k=0;k<this.m_bodyContactBuffer.count;k++){var contact=this.m_bodyContactBuffer.data[k];var a=contact.index;var aGroup=this.m_groupBuffer[a];if(aGroup&&this.IsRigidGroup(aGroup)){var b=contact.body;var n=contact.normal;var w=contact.weight;var p=pos_data[a];///b2Vec2 v = b.GetLinearVelocityFromWorldPoint(p) - aGroup.GetLinearVelocityFromWorldPoint(p);
...
this.ApplyDamping(invMassB[0],invInertiaB[0],tangentDistanceB[0],bRigid,bGroup,_b11,-_f4,_n3);}}}}},{key:'SolveExtraDamping',value:function SolveExtraDamping(){var s_v=b2ParticleSystem.SolveExtraDamping_s_v;var s_f=b2ParticleSystem.SolveExtraDamping_s_f;if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var vel_data=this.m_velocityBuffer.data;// Applies additional damping force between bodies and particles which can
...
vel_data[a].SelfMulAdd(inv_mass,f);///b.ApplyLinearImpulse(-f, p, true);
b.ApplyLinearImpulse(f.SelfNeg(),p,true);}}}}},{key:'SolveWall',value:function SolveWall(){if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var vel_data=this.m_velocityBuffer.data;for(var i=0;i<this.m_count;i++){if(this.m_flagsBuffer.data[i]&exports.b2ParticleFlag.b2_wallParticle){vel_data[i].SetZero();}}}},{key:'SolveRigid',value:function SolveRigid(step){var s_position=b2ParticleSystem.SolveRigid_s_position;var s_rotation=b2ParticleSystem.SolveRigid_s_rotation;var s_transform=b2ParticleSystem.SolveRigid_s_transform;var s_velocityTransform=b2ParticleSystem.SolveRigid_s_velocityTransform;if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;for(var group=this.m_groupList;group;group=group.GetNext()){if(group.m_groupFlags&exports.b2ParticleGroupFlag.b2_rigidParticleGroup){group.UpdateStatistics();///b2Rot rotation(step.dt * group.m_angularVelocity);
...
b2Transform.MulXV(velocityTransform,pos_data[i],vel_data[i]);}}}}},{key:'SolveElastic',value:function SolveElastic(step){var s_pa=b2ParticleSystem.SolveElastic_s_pa;var s_pb=b2ParticleSystem.SolveElastic_s_pb;var s_pc=b2ParticleSystem.SolveElastic_s_pc;var s_r=b2ParticleSystem.SolveElastic_s_r;var s_t0=b2ParticleSystem.SolveElastic_s_t0;if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;var elasticStrength=step.inv_dt*this.m_def.elasticStrength;for(var k=0;k<this.m_triadBuffer.count;k++){var triad=this.m_triadBuffer.data[k];if(triad.flags&exports.b2ParticleFlag.b2_elasticParticle){var a=triad.indexA;var b=triad.indexB;var c=triad.indexC;var oa=triad.pa;var ob=triad.pb;var oc=triad.pc;///b2Vec2 pa = m_positionBuffer.data[a];
...
b2Rot.MulRV(r,oc,s_t0);b2Vec2.SubVV(s_t0,pc,s_t0);b2Vec2.MulSV(strength,s_t0,s_t0);vc.SelfAdd(s_t0);}}}},{key:'SolveSpring',value:function SolveSpring(step){var s_pa=b2ParticleSystem.SolveSpring_s_pa;var s_pb=b2ParticleSystem.SolveSpring_s_pb;var s_d=b2ParticleSystem.SolveSpring_s_d;var s_f=b2ParticleSystem.SolveSpring_s_f;if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;var springStrength=step.inv_dt*this.m_def.springStrength;for(var k=0;k<this.m_pairBuffer.count;k++){var pair=this.m_pairBuffer.data[k];if(pair.flags&exports.b2ParticleFlag.b2_springParticle){///int32 a = pair.indexA;
...
va.SelfSub(f);///vb += f;
vb.SelfAdd(f);}}}},{key:'SolveTensile',value:function SolveTensile(step){var s_weightedNormal=b2ParticleSystem.SolveTensile_s_weightedNormal;var s_s=b2ParticleSystem.SolveTensile_s_s;var s_f=b2ParticleSystem.SolveTensile_s_f;if(!this.m_velocityBuffer.data){throw new Error();}var vel_data=this.m_velocityBuffer.data;// DEBUG: b2Assert(this.m_accumulation2Buffer !== null);
...
vel_data[_b12].SelfAdd(f);}}}},{key:'SolveViscous',value:function SolveViscous(){var s_v=b2ParticleSystem.SolveViscous_s_v;var s_f=b2ParticleSystem.SolveViscous_s_f;if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}var pos_data=this.m_positionBuffer.data;var vel_data=this.m_velocityBuffer.data;var viscousStrength=this.m_def.viscousStrength;var inv_mass=this.GetParticleInvMass();for(var k=0;k<this.m_bodyContactBuffer.count;k++){var contact=this.m_bodyContactBuffer.data[k];var a=contact.index;if(this.m_flagsBuffer.data[a]&exports.b2ParticleFlag.b2_viscousParticle){var b=contact.body;var w=contact.weight;var m=contact.mass;var p=pos_data[a];///b2Vec2 v = b.GetLinearVelocityFromWorldPoint(p) - m_velocityBuffer.data[a];
...
// this correctly.
b2Color.MixColors(colorA,colorB,colorMixing);}}}}},{key:'SolveZombie',value:function SolveZombie(){if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}// removes particles with zombie flag
...
this.m_allParticleFlags=allParticleFlags;this.m_needsUpdateAllParticleFlags=false;// destroy bodies with no particles
for(var _group3=this.m_groupList;_group3;){var next=_group3.GetNext();if(_group3.m_groupFlags&exports.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed){this.DestroyParticleGroup(_group3);}_group3=next;}}/**
       ...
       */},{key:'SolveLifetimes',value:function SolveLifetimes(step){if(!this.m_expirationTimeBuffer.data){throw new Error();}if(!this.m_indexByExpirationTimeBuffer.data){throw new Error();}// Update the time elapsed.
...
function newIndices(i){if(i<start){return i;}else if(i<mid){return i+end-mid;}else if(i<end){return i+start-mid;}else{return i;}}if(!this.m_flagsBuffer.data){throw new Error();}if(!this.m_positionBuffer.data){throw new Error();}if(!this.m_velocityBuffer.data){throw new Error();}///std::rotate(m_flagsBuffer.data + start, m_flagsBuffer.data + mid, m_flagsBuffer.data + end);
...
var particleCount=this.GetParticleCount();if(!this.m_indexByExpirationTimeBuffer.data){throw new Error();}var indexByExpirationTime=this.m_indexByExpirationTimeBuffer.data;for(var _i40=0;_i40<particleCount;++_i40){indexByExpirationTime[_i40]=newIndices(indexByExpirationTime[_i40]);}}// update proxies
...
var inverseStride=this.m_inverseDiameter*(1.0/b2_particleStride);return this.m_inverseDensity*inverseStride*inverseStride;}/**
       ...
       * system.
       */},{key:'GetParticleContactListener',value:function GetParticleContactListener(){return this.m_allParticleFlags&exports.b2ParticleFlag.b2_particleContactListenerParticle?this.m_world.m_contactManager.m_contactListener:null;}},{key:'SetUserOverridableBuffer',value:function SetUserOverridableBuffer(buffer,newData,newCapacity){// DEBUG: b2Assert(((newData !== null) && (newCapacity > 0)) || ((newData === null) && (newCapacity === 0)));
///if (!buffer.userSuppliedCapacity)
///{
///this.m_world.m_blockAllocator.Free(buffer.data, sizeof(T) * m_internalAllocatedCapacity);
///}
buffer.data=newData;buffer.userSuppliedCapacity=newCapacity;}},{key:'SetGroupFlags',value:function SetGroupFlags(group,newFlags){var oldFlags=group.m_groupFlags;if((oldFlags^newFlags)&exports.b2ParticleGroupFlag.b2_solidParticleGroup){// If the b2_solidParticleGroup flag changed schedule depth update.
...
if(!system.m_positionBuffer.data){throw new Error();}var pos=b2Vec2.AddVV(system.m_positionBuffer.data[contact.index],n,s_pos);// pos is now a point projected back along the contact normal to the
...
// such particles.
if(this.m_stuckThreshold<=0){return;}if(!this.m_bodyContactCountBuffer.data){throw new Error();}if(!this.m_consecutiveContactStepsBuffer.data){throw new Error();}if(!this.m_lastBodyContactStepBuffer.data){throw new Error();}// Get the state variables for this particle.
...
for(var i=0;i<this.m_count;i++){this.m_forceBuffer[i].SetZero();}this.m_hasForce=true;}}},{key:'IsRigidGroup',value:function IsRigidGroup(group){return group!==null&&(group.m_groupFlags&exports.b2ParticleGroupFlag.b2_rigidParticleGroup)!==0;}},{key:'GetLinearVelocity',value:function GetLinearVelocity(group,particleIndex,point,out){if(group&&this.IsRigidGroup(group)){return group.GetLinearVelocityFromWorldPoint(point,out);}else{if(!this.m_velocityBuffer.data){throw new Error();}///return m_velocityBuffer.data[particleIndex];
...
if(xTag>=this.m_xLower&&xTag<=this.m_xUpper){return this.m_system.m_proxyBuffer.data[this.m_first++].index;}this.m_first++;}return b2_invalidParticleIndex;}}]);return InsideBoundsEnumerator;}();b2ParticleSystem.InsideBoundsEnumerator=InsideBoundsEnumerator;var ParticleListNode=function ParticleListNode(){_classCallCheck(this,ParticleListNode);/**
               ...
               */this.count=0;/**
               * Particle index.
               */this.index=0;};b2ParticleSystem.ParticleListNode=ParticleListNode;/**
       * @constructor
       */var FixedSetAllocator=function(){function FixedSetAllocator(){_classCallCheck(this,FixedSetAllocator);}_createClass(FixedSetAllocator,[{key:'Allocate',value:function Allocate(itemSize,count){// TODO
...
}}]);return FixedSetAllocator;}();b2ParticleSystem.FixedSetAllocator=FixedSetAllocator;var FixtureParticle=function FixtureParticle(fixture,particle){_classCallCheck(this,FixtureParticle);this.second=b2_invalidParticleIndex;this.first=fixture;this.second=particle;};b2ParticleSystem.FixtureParticle=FixtureParticle;var FixtureParticleSet=function(_b2ParticleSystem$Fix){_inherits(FixtureParticleSet,_b2ParticleSystem$Fix);function FixtureParticleSet(){_classCallCheck(this,FixtureParticleSet);return _possibleConstructorReturn(this,(FixtureParticleSet.__proto__||Object.getPrototypeOf(FixtureParticleSet)).apply(this,arguments));}_createClass(FixtureParticleSet,[{key:'Initialize',value:function Initialize(bodyContactBuffer,flagsBuffer){// TODO
}},{key:'Find',value:function Find(pair){// TODO
return b2_invalidParticleIndex;}}]);return FixtureParticleSet;}(b2ParticleSystem.FixedSetAllocator);b2ParticleSystem.FixtureParticleSet=FixtureParticleSet;var ParticlePair=function ParticlePair(particleA,particleB){_classCallCheck(this,ParticlePair);this.first=b2_invalidParticleIndex;this.second=b2_invalidParticleIndex;this.first=particleA;this.second=particleB;};b2ParticleSystem.ParticlePair=ParticlePair;var b2ParticlePairSet=function(_b2ParticleSystem$Fix2){_inherits(b2ParticlePairSet,_b2ParticleSystem$Fix2);function b2ParticlePairSet(){_classCallCheck(this,b2ParticlePairSet);return _possibleConstructorReturn(this,(b2ParticlePairSet.__proto__||Object.getPrototypeOf(b2ParticlePairSet)).apply(this,arguments));}_createClass(b2ParticlePairSet,[{key:'Initialize',value:function Initialize(contactBuffer,flagsBuffer){// TODO
}},{key:'Find',value:function Find(pair){// TODO
return b2_invalidParticleIndex;}}]);return b2ParticlePairSet;}(b2ParticleSystem.FixedSetAllocator);b2ParticleSystem.b2ParticlePairSet=b2ParticlePairSet;var ConnectionFilter=function(){function ConnectionFilter(){_classCallCheck(this,ConnectionFilter);}_createClass(ConnectionFilter,[{key:'IsNecessary',/**
           ...
           */},{key:'ShouldCreateTriad',value:function ShouldCreateTriad(a,b,c){return true;}}]);return ConnectionFilter;}();b2ParticleSystem.ConnectionFilter=ConnectionFilter;var DestroyParticlesInShapeCallback=function(_b2QueryCallback2){_inherits(DestroyParticlesInShapeCallback,_b2QueryCallback2);function DestroyParticlesInShapeCallback(system,shape,xf,callDestructionListener){_classCallCheck(this,DestroyParticlesInShapeCallback);var _this43=_possibleConstructorReturn(this,(DestroyParticlesInShapeCallback.__proto__||Object.getPrototypeOf(DestroyParticlesInShapeCallback)).call(this));_this43.m_callDestructionListener=false;_this43.m_destroyed=0;_this43.m_system=system;_this43.m_shape=shape;_this43.m_xf=xf;_this43.m_callDestructionListener=callDestructionListener;_this43.m_destroyed=0;return _this43;}_createClass(DestroyParticlesInShapeCallback,[{key:'ReportFixture',value:function ReportFixture(fixture){return false;}},{key:'ReportParticle',value:function ReportParticle(particleSystem,index){if(particleSystem!==this.m_system){return false;}// DEBUG: b2Assert(index >= 0 && index < this.m_system.m_count);
if(!this.m_system.m_positionBuffer.data){throw new Error();}if(this.m_shape.TestPoint(this.m_xf,this.m_system.m_positionBuffer.data[index])){this.m_system.DestroyParticle(index,this.m_callDestructionListener);this.m_destroyed++;}return true;}},{key:'Destroyed',value:function Destroyed(){return this.m_destroyed;}}]);return DestroyParticlesInShapeCallback;}(b2QueryCallback);b2ParticleSystem.DestroyParticlesInShapeCallback=DestroyParticlesInShapeCallback;var JoinParticleGroupsFilter=function(_b2ParticleSystem$Con){_inherits(JoinParticleGroupsFilter,_b2ParticleSystem$Con);function JoinParticleGroupsFilter(threshold){_classCallCheck(this,JoinParticleGroupsFilter);var _this44=_possibleConstructorReturn(this,(JoinParticleGroupsFilter.__proto__||Object.getPrototypeOf(JoinParticleGroupsFilter)).call(this));_this44.m_threshold=0;_this44.m_threshold=threshold;return _this44;}/**
           * An additional condition for creating a pair.
           */_createClass(JoinParticleGroupsFilter,[{key:'ShouldCreatePair',value:function ShouldCreatePair(a,b){return a<this.m_threshold&&this.m_threshold<=b||b<this.m_threshold&&this.m_threshold<=a;}/**
           * An additional condition for creating a triad.
           */},{key:'ShouldCreateTriad',value:function ShouldCreateTriad(a,b,c){return(a<this.m_threshold||b<this.m_threshold||c<this.m_threshold)&&(this.m_threshold<=a||this.m_threshold<=b||this.m_threshold<=c);}}]);return JoinParticleGroupsFilter;}(b2ParticleSystem.ConnectionFilter);b2ParticleSystem.JoinParticleGroupsFilter=JoinParticleGroupsFilter;var CompositeShape=function(_b2Shape5){_inherits(CompositeShape,_b2Shape5);function CompositeShape(shapes){var shapeCount=arguments.length>1&&arguments[1]!==undefined?arguments[1]:shapes.length;_classCallCheck(this,CompositeShape);var _this45=_possibleConstructorReturn(this,(CompositeShape.__proto__||Object.getPrototypeOf(CompositeShape)).call(this,exports.b2ShapeType.e_unknown,0));_this45.m_shapeCount=0;_this45.m_shapes=shapes;_this45.m_shapeCount=shapeCount;return _this45;}_createClass(CompositeShape,[{key:'Clone',value:function Clone(){// DEBUG: b2Assert(false);
...
}}]);return CompositeShape;}(b2Shape);b2ParticleSystem.CompositeShape=CompositeShape;var ReactiveFilter=function(_b2ParticleSystem$Con2){_inherits(ReactiveFilter,_b2ParticleSystem$Con2);function ReactiveFilter(flagsBuffer){_classCallCheck(this,ReactiveFilter);var _this46=_possibleConstructorReturn(this,(ReactiveFilter.__proto__||Object.getPrototypeOf(ReactiveFilter)).call(this));_this46.m_flagsBuffer=flagsBuffer;return _this46;}_createClass(ReactiveFilter,[{key:'IsNecessary',value:function IsNecessary(index){if(!this.m_flagsBuffer.data){throw new Error();}return(this.m_flagsBuffer.data[index]&exports.b2ParticleFlag.b2_reactiveParticle)!==0;}}]);return ReactiveFilter;}(b2ParticleSystem.ConnectionFilter);b2ParticleSystem.ReactiveFilter=ReactiveFilter;var UpdateBodyContactsCallback=function(_b2FixtureParticleQue){_inherits(UpdateBodyContactsCallback,_b2FixtureParticleQue);function UpdateBodyContactsCallback(system,contactFilter){_classCallCheck(this,UpdateBodyContactsCallback);// base class constructor
var _this47=_possibleConstructorReturn(this,(UpdateBodyContactsCallback.__proto__||Object.getPrototypeOf(UpdateBodyContactsCallback)).call(this,system));_this47.m_contactFilter=contactFilter;return _this47;}_createClass(UpdateBodyContactsCallback,[{key:'ShouldCollideFixtureParticle',value:function ShouldCollideFixtureParticle(fixture,particleSystem,particleIndex){// Call the contact filter if it's set, to determine whether to
// filter this contact.  Returns true if contact calculations should
// be performed, false otherwise.
if(this.m_contactFilter){var flags=this.m_system.GetFlagsBuffer();if(flags[particleIndex]&exports.b2ParticleFlag.b2_fixtureContactFilterParticle){return this.m_contactFilter.ShouldCollideFixtureParticle(fixture,this.m_system,particleIndex);}}return true;}},{key:'ReportFixtureAndParticle',value:function ReportFixtureAndParticle(fixture,childIndex,a){var s_n=b2ParticleSystem.UpdateBodyContactsCallback.ReportFixtureAndParticle_s_n;var s_rp=b2ParticleSystem.UpdateBodyContactsCallback.ReportFixtureAndParticle_s_rp;if(!this.m_system.m_flagsBuffer.data){throw new Error();}if(!this.m_system.m_positionBuffer.data){throw new Error();}var ap=this.m_system.m_positionBuffer.data[a];var n=s_n;var d=fixture.ComputeDistance(ap,n,childIndex);if(d<this.m_system.m_particleDiameter&&this.ShouldCollideFixtureParticle(fixture,this.m_system,a)){var b=fixture.GetBody();var bp=b.GetWorldCenter();var bm=b.GetMass();var bI=b.GetInertia()-bm*b.GetLocalCenter().LengthSquared();var invBm=bm>0?1/bm:0;var invBI=bI>0?1/bI:0;var invAm=this.m_system.m_flagsBuffer.data[a]&exports.b2ParticleFlag.b2_wallParticle?0:this.m_system.GetParticleInvMass();///b2Vec2 rp = ap - bp;
...
contact.normal.Copy(n.SelfNeg());contact.mass=invM>0?1/invM:0;this.m_system.DetectStuckParticle(a);}}}]);return UpdateBodyContactsCallback;}(b2FixtureParticleQueryCallback);UpdateBodyContactsCallback.ReportFixtureAndParticle_s_n=new b2Vec2();UpdateBodyContactsCallback.ReportFixtureAndParticle_s_rp=new b2Vec2();b2ParticleSystem.UpdateBodyContactsCallback=UpdateBodyContactsCallback;var SolveCollisionCallback=function(_b2FixtureParticleQue2){_inherits(SolveCollisionCallback,_b2FixtureParticleQue2);function SolveCollisionCallback(system,step){_classCallCheck(this,SolveCollisionCallback);// base class constructor
var _this48=_possibleConstructorReturn(this,(SolveCollisionCallback.__proto__||Object.getPrototypeOf(SolveCollisionCallback)).call(this,system));_this48.m_step=step;return _this48;}_createClass(SolveCollisionCallback,[{key:'ReportFixtureAndParticle',value:function ReportFixtureAndParticle(fixture,childIndex,a){var s_p1=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_p1;var s_output=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_output;var s_input=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_input;var s_p=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_p;var s_v=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_v;var s_f=b2ParticleSystem.SolveCollisionCallback.ReportFixtureAndParticle_s_f;var body=fixture.GetBody();if(!this.m_system.m_positionBuffer.data){throw new Error();}if(!this.m_system.m_velocityBuffer.data){throw new Error();}var ap=this.m_system.m_positionBuffer.data[a];var av=this.m_system.m_velocityBuffer.data[a];var output=s_output;var input=s_input;if(this.m_system.m_iterationIndex===0){// Put 'ap' in the local space of the previous frame
...
var f=s_f;f.x=this.m_step.inv_dt*this.m_system.GetParticleMass()*(av.x-v.x);f.y=this.m_step.inv_dt*this.m_system.GetParticleMass()*(av.y-v.y);this.m_system.ParticleApplyForce(a,f);}}},{key:'ReportParticle',value:function ReportParticle(system,index){return false;}}]);return SolveCollisionCallback;}(b2FixtureParticleQueryCallback);SolveCollisionCallback.ReportFixtureAndParticle_s_p1=new b2Vec2();SolveCollisionCallback.ReportFixtureAndParticle_s_output=new b2RayCastOutput();SolveCollisionCallback.ReportFixtureAndParticle_s_input=new b2RayCastInput();SolveCollisionCallback.ReportFixtureAndParticle_s_p=new b2Vec2();SolveCollisionCallback.ReportFixtureAndParticle_s_v=new b2Vec2();SolveCollisionCallback.ReportFixtureAndParticle_s_f=new b2Vec2();b2ParticleSystem.SolveCollisionCallback=SolveCollisionCallback;})(b2ParticleSystem||(b2ParticleSystem={}));// #endif
/*
  * Copyright (c) 2006-2011 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
...
var b2World=function(){// #endif
/// Construct a world object.
/// @param gravity the world gravity vector.
function b2World(gravity){_classCallCheck(this,b2World);// b2BlockAllocator m_blockAllocator;
// b2StackAllocator m_stackAllocator;
this.m_newFixture=false;this.m_locked=false;this.m_clearForces=true;this.m_contactManager=new b2ContactManager();this.m_bodyList=null;this.m_jointList=null;// #if B2_ENABLE_PARTICLE
...
var f=b.m_fixtureList;while(f){var f0=f;f=f.m_next;if(this.m_destructionListener){this.m_destructionListener.SayGoodbyeFixture(f0);}f0.DestroyProxies();f0.Destroy();b.m_fixtureList=f;b.m_fixtureCount-=1;}b.m_fixtureList=null;b.m_fixtureCount=0;// Remove world body list.
if(b.m_prev){b.m_prev.m_next=b.m_next;}if(b.m_next){b.m_next.m_prev=b.m_prev;}if(b===this.m_bodyList){this.m_bodyList=b.m_next;}--this.m_bodyCount;}},{key:'CreateJoint',value:function CreateJoint(def){if(this.IsLocked()){throw new Error();}var j=b2World._Joint_Create(def,null);// Connect to the world list.
...
j.m_edgeA.prev=null;j.m_edgeA.next=j.m_bodyA.m_jointList;if(j.m_bodyA.m_jointList){j.m_bodyA.m_jointList.prev=j.m_edgeA;}j.m_bodyA.m_jointList=j.m_edgeA;// j.m_edgeB.joint = j;
// j.m_edgeB.other = j.m_bodyA;
j.m_edgeB.prev=null;j.m_edgeB.next=j.m_bodyB.m_jointList;if(j.m_bodyB.m_jointList){j.m_bodyB.m_jointList.prev=j.m_edgeB;}j.m_bodyB.m_jointList=j.m_edgeB;var bodyA=def.bodyA;var bodyB=def.bodyB;// If the joint prevents collisions, then flag any contacts for filtering.
if(!def.collideConnected){var edge=bodyB.GetContactList();while(edge){if(edge.other===bodyA){// Flag the contact for filtering at the next time step (where either
// body is awake).
...
/// @warning This function is locked during callbacks.
},{key:'DestroyJoint',value:function DestroyJoint(j){if(this.IsLocked()){throw new Error();}var collideConnected=j.m_collideConnected;// Remove from the doubly linked list.
...
var bodyA=j.m_bodyA;var bodyB=j.m_bodyB;// Wake up connected bodies.
bodyA.SetAwake(true);bodyB.SetAwake(true);// Remove from body 1.
if(j.m_edgeA.prev){j.m_edgeA.prev.next=j.m_edgeA.next;}if(j.m_edgeA.next){j.m_edgeA.next.prev=j.m_edgeA.prev;}if(j.m_edgeA===bodyA.m_jointList){bodyA.m_jointList=j.m_edgeA.next;}j.m_edgeA.prev=null;j.m_edgeA.next=null;// Remove from body 2
if(j.m_edgeB.prev){j.m_edgeB.prev.next=j.m_edgeB.next;}if(j.m_edgeB.next){j.m_edgeB.next.prev=j.m_edgeB.prev;}if(j.m_edgeB===bodyB.m_jointList){bodyB.m_jointList=j.m_edgeB.next;}j.m_edgeB.prev=null;j.m_edgeB.next=null;b2World._Joint_Destroy(j,null);// DEBUG: b2Assert(this.m_jointCount > 0);
...
/// @param callback a user implemented callback class.
/// @param aabb the query box.
},{key:'QueryAABB',value:function QueryAABB(callback,aabb,fn){this.m_contactManager.m_broadPhase.Query(aabb,function(proxy){var fixture_proxy=proxy.userData;// DEBUG: b2Assert(fixture_proxy instanceof b2FixtureProxy);
...
}},{key:'QueryAllAABB',value:function QueryAllAABB(aabb){var out=arguments.length>1&&arguments[1]!==undefined?arguments[1]:[];this.QueryAABB(null,aabb,function(fixture){out.push(fixture);return true;});return out;}/// Query the world for all fixtures that potentially overlap the
/// provided point.
/// @param callback a user implemented callback class.
/// @param point the query point.
},{key:'QueryPointAABB',value:function QueryPointAABB(callback,point,fn){this.m_contactManager.m_broadPhase.QueryPoint(point,function(proxy){var fixture_proxy=proxy.userData;// DEBUG: b2Assert(fixture_proxy instanceof b2FixtureProxy);
var fixture=fixture_proxy.fixture;if(callback){return callback.ReportFixture(fixture);}else if(fn){return fn(fixture);}return true;});// #if B2_ENABLE_PARTICLE
...
}},{key:'QueryAllFixturePoint',value:function QueryAllFixturePoint(point){var out=arguments.length>1&&arguments[1]!==undefined?arguments[1]:[];this.QueryFixturePoint(null,point,function(fixture){out.push(fixture);return true;});return out;}},{key:'RayCast',value:function RayCast(callback,point1,point2,fn){var input=b2World.RayCast_s_input;input.maxFraction=1;input.p1.Copy(point1);input.p2.Copy(point2);this.m_contactManager.m_broadPhase.RayCast(input,function(input,proxy){var fixture_proxy=proxy.userData;// DEBUG: b2Assert(fixture_proxy instanceof b2FixtureProxy);
...
var island=this.m_island;island.Initialize(this.m_bodyCount,this.m_contactManager.m_contactCount,this.m_jointCount,null,// this.m_stackAllocator,
...
var sensorA=contact.m_fixtureA.m_isSensor;var sensorB=contact.m_fixtureB.m_isSensor;if(sensorA||sensorB){continue;}island.AddContact(contact);contact.m_islandFlag=true;var other=ce.other;if(!other){throw new Error();}// Was the other body already added to this island?
...
this.m_contactManager.FindNewContacts();this.m_profile.broadphase=timer.GetMilliseconds();}},{key:'SolveTOI',value:function SolveTOI(step){// b2Island island(2 * b2_maxTOIContacts, b2_maxTOIContacts, 0, &m_stackAllocator, m_contactManager.m_contactListener);
var island=this.m_island;island.Initialize(2*b2_maxTOIContacts,b2_maxTOIContacts,0,null,this.m_contactManager.m_contactListener);if(this.m_stepComplete){for(var b=this.m_bodyList;b;b=b.m_next){b.m_islandFlag=false;b.m_sweep.alpha0=0;}for(var c=this.m_contactManager.m_contactList;c;c=c.m_next){// Invalidate TOI
...
this.controller=controller;this.body=body;};/**
   ...
   */var b2Controller=function(){function b2Controller(){_classCallCheck(this,b2Controller);// m_world: b2World;
...
/*
   ...
   * plane.
   */var b2BuoyancyController=function(_b2Controller){_inherits(b2BuoyancyController,_b2Controller);function b2BuoyancyController(){_classCallCheck(this,b2BuoyancyController);/**
           * The outer surface normal
           */var _this49=_possibleConstructorReturn(this,(b2BuoyancyController.__proto__||Object.getPrototypeOf(b2BuoyancyController)).apply(this,arguments));_this49.normal=new b2Vec2(0,1);/**
           * The height of the fluid surface along the normal
           */_this49.offset=0;/**
           * The fluid density
           */_this49.density=0;/**
           * Fluid velocity, for drag calculations
           */_this49.velocity=new b2Vec2(0,0);/**
           * Linear drag co-efficient
           */_this49.linearDrag=0;/**
           * Angular drag co-efficient
           */_this49.angularDrag=0;/**
           * If false, bodies are assumed to be uniformly dense, otherwise
           * use the shapes densities
           */_this49.useDensity=false;//False by default to prevent a gotcha
/**
           * If true, gravity is taken from the world instead of the
           */_this49.useWorldGravity=true;/**
           * Gravity vector, if the world's gravity is not used
           */_this49.gravity=new b2Vec2(0,0);return _this49;}_createClass(b2BuoyancyController,[{key:'Step',value:function Step(step){if(!this.m_bodyList){return;}if(this.useWorldGravity){this.gravity.Copy(this.m_bodyList.body.GetWorld().GetGravity());}for(var i=this.m_bodyList;i;i=i.nextBody){var body=i.body;if(!body.IsAwake()){//Buoyancy force is just a function of position,
...
/*
   ...
   */var b2ConstantAccelController=function(_b2Controller2){_inherits(b2ConstantAccelController,_b2Controller2);function b2ConstantAccelController(){_classCallCheck(this,b2ConstantAccelController);/**
           * The acceleration to apply
           */var _this50=_possibleConstructorReturn(this,(b2ConstantAccelController.__proto__||Object.getPrototypeOf(b2ConstantAccelController)).apply(this,arguments));_this50.A=new b2Vec2(0,0);return _this50;}_createClass(b2ConstantAccelController,[{key:'Step',value:function Step(step){var dtA=b2Vec2.MulSV(step.dt,this.A,b2ConstantAccelController.Step_s_dtA);for(var i=this.m_bodyList;i;i=i.nextBody){var body=i.body;if(!body.IsAwake()){continue;}body.SetLinearVelocity(b2Vec2.AddVV(body.GetLinearVelocity(),dtA,b2Vec2.s_t0));}}},{key:'Draw',value:function Draw(draw){}}]);return b2ConstantAccelController;}(b2Controller);b2ConstantAccelController.Step_s_dtA=new b2Vec2();// #endif
/*
   * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
   *
   * This software is provided 'as-is', without any express or implied
   ...
   *//**
   * Applies a force every frame
   */var b2ConstantForceController=function(_b2Controller3){_inherits(b2ConstantForceController,_b2Controller3);function b2ConstantForceController(){_classCallCheck(this,b2ConstantForceController);/**
           * The force to apply
           */var _this51=_possibleConstructorReturn(this,(b2ConstantForceController.__proto__||Object.getPrototypeOf(b2ConstantForceController)).apply(this,arguments));_this51.F=new b2Vec2(0,0);return _this51;}_createClass(b2ConstantForceController,[{key:'Step',value:function Step(step){for(var i=this.m_bodyList;i;i=i.nextBody){var body=i.body;if(!body.IsAwake()){continue;}body.ApplyForce(this.F,body.GetWorldCenter());}}},{key:'Draw',value:function Draw(draw){}}]);return b2ConstantForceController;}(b2Controller);// #endif
/*
   * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
   *
   * This software is provided 'as-is', without any express or implied
   ...
   */var b2GravityController=function(_b2Controller4){_inherits(b2GravityController,_b2Controller4);function b2GravityController(){_classCallCheck(this,b2GravityController);/**
           * Specifies the strength of the gravitiation force
           */var _this52=_possibleConstructorReturn(this,(b2GravityController.__proto__||Object.getPrototypeOf(b2GravityController)).apply(this,arguments));_this52.G=1;/**
           * If true, gravity is proportional to r^-2, otherwise r^-1
           */_this52.invSqr=true;return _this52;}/**
...
/*
   ...
   */var b2TensorDampingController=function(_b2Controller5){_inherits(b2TensorDampingController,_b2Controller5);function b2TensorDampingController(){_classCallCheck(this,b2TensorDampingController);/// Tensor to use in damping model
var _this53=_possibleConstructorReturn(this,(b2TensorDampingController.__proto__||Object.getPrototypeOf(b2TensorDampingController)).apply(this,arguments));_this53.T=new b2Mat22();/*Some examples (matrixes in format (row1; row2))
...
_this53.maxTimestep=0;return _this53;}// Typically one wants maxTimestep to be 1/(max eigenvalue of T), so that damping will never cause something to reverse direction
/**
       * @see b2Controller::Step
...
b2Rope.s_d=new b2Vec2();b2Rope.s_d1=new b2Vec2();b2Rope.s_d2=new b2Vec2();b2Rope.s_Jd1=new b2Vec2();b2Rope.s_Jd2=new b2Vec2();b2Rope.s_J1=new b2Vec2();b2Rope.s_J2=new b2Vec2();/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
