...
<project name="game1" version="2.2" showFps="0" openLog="1" fps="60" scaleMode="0" orientaion="0" renderMode="1" bgColor="0" stagewidth="414" stageheight="736" startscenename="MainScene">
  <objects>
  ...
  <eventsheet>
    <sheet name="MainSceneEventSheet" targetscene="MainScene">
      <p key="ballNum" value="5" valuetype="number"/>
      ...
      <event name="null" enabled="true" relation="1" triggerOnceWhileTrue="false">
        ...
        <actions>
          <action type="setVisible" targetuiname="AITextField586" targetuitype="AITextField" isConflict="false" enabled="true">
            <properties>
